$(document).ready(function () {
    let vat_percentage = document.getElementById('vat_percentage').value;
    let rounding_placeholder = document.getElementById('rounding_placeholder').value;
    let cancel_rounding_placeholder = document.getElementById('cancel_rounding_placeholder').value;
    let count = 1,
        price,
        quantity,
        calc_amount_taxable,
    ...
    function rounding_amount (){
        ...
        if (that.hasClass('btn-danger'))
        {
            ...
            _amount_due_element.val(toTwoDecimalPlaces(_total_amount_due_element.val() - total_amounts - calc_supplier_discount_amount()));
            that.addClass('btn-success').removeClass('btn-danger').text(rounding_placeholder);
        }
        else
        {
            // Make Rounding
            ...
            _amount_due_element.val(toTwoDecimalPlaces(_total_amount_due_element.val() - total_amounts - calc_supplier_discount_amount()));
            that.removeClass('btn-success').addClass('btn-danger').text(cancel_rounding_placeholder);
        }
    }
    ...
    $(document).on('keyup change', ':input', function () {
        ...
        calc_tax_amount = parseFloat(((calc_amount_taxable - discount_amount_or_percentage) * (vat_percentage/100)).toFixed(2));
