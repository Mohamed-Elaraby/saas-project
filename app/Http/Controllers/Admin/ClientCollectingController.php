...
class ClientCollectingController extends Controller
{
    ...
    public function index(ClientCollectingDataTable $clientPaymentDatatable)
    {
        return  $clientPaymentDatatable -> render('admin.clientCollecting.index');
    }
...
//        dd($request->payment_method_bank);
        ...
        $this -> insertToClientTransaction(
            ...
            [
                ...
                'details'                       => __('trans.collecting document') . ' ' . $clientCollecting -> receipt_number,
                'amount_paid'                   => $amount_paid,
...
//        dd($amount_paid,$amount_paid_bank,$amount_paid_network,$amount_paid_bank_transfer);
        $this -> insertToStatement(
            ...
            [
                ...
                'notes'                         =>  __('trans.collecting document from client') . ' ' . $clientCollecting -> client -> name,
        ...
        toast(__('trans.client collecting created successfully'),'success')->background('#000');
        return redirect()->route('admin.clientCollecting.show', $collecting_id);
    }
