...
//        dd($request->all());
        ...
        $this -> insertToSupplierTransaction(
            ...
            [
                ...
                'details'                       => __('trans.collecting document') . ' ' . $supplierCollecting -> receipt_number,
                'amount_paid'                   => $amount_paid,
        ...
        $this -> insertToStatement(
            ...
            [
                ...
                'notes'                         =>  __('trans.collecting document from supplier') . ' ' . $supplierCollecting -> supplier -> name,
                'branch_id'                     =>  $request -> branch_id,
            ]
        );
        toast(__('trans.supplier collecting created successfully'),'success')->background('#000');
        return redirect()->route('admin.supplierCollecting.show', $collecting_id);
    }
