...
class SupplierCollectingDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('receipt_number', function ($query){
                return '<a href="'.route('admin.supplierCollecting.show', $query -> id).'">#'.$query -> receipt_number.'</a>';
            })
            ...
            ->addColumn('source', function ($query){
                return '<a class="btn btn-primary btn-sm" href="'.route('admin.supplierCollecting.show', $query -> id).'">'. __('trans.supplier collecting') .'</a>';
            })
     ...
     */
    public function query(SupplierCollecting $model): QueryBuilder
    {
        // Search Parameters
    ...
    {
        return $this->builder()
            ->setTableId('suppliercollecting-table')
