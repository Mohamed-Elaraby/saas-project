...
class ClientPaymentDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('receipt_number', function ($query){
                return '<a href="'.route('admin.clientPayments.show', $query -> id).'">#'.$query -> receipt_number.'</a>';
            })
            ...
            ->addColumn('source', function ($query){
                return '<a class="btn btn-primary btn-sm" href="'.route('admin.clientPayments.show', $query -> id).'">'. __('trans.client payment') .'</a>';
            })
     ...
     */
    public function query(ClientPayment $model): QueryBuilder
    {
        // Search Parameters
    ...
    {
        return $this->builder()
                ->setTableId('clientpayment-table')
