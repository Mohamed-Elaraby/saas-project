...
{{--                                    <img src="{{asset('storage/header/logo_transparent.png')}}" alt="logo" width="173" height="72" class="desktop-logo">--}}
                    ...
                    <ul class="header-content-right">
                        ...
                        <li class="header-element country-selector dropdown">
                            ...
                            <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown">
                                <img src="{{asset('build/assets/images/flags/us_flag.jpg')}}" alt="img" class="header-link-icon">
                            </a>
                            ...
                            <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                                ...
                                <ul class="list-unstyled mb-0" id="header-notification-scroll">
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                                <div>
                                                    <p class="mb-0 fw-medium"><a href="{{url('notifications')}}">Jessica Lily</a></p>
                                    ...
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                                <div>
                                                    <p class="mb-0 fw-medium"><a href="{{url('notifications')}}">Payment Received</a></p>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="pe-2 lh-1">
                                                <span class="avatar bg-secondary-transparent avatar-rounded">
                                                    <img src="{{asset('build/assets/images/faces/23.jpg')}}" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                                <div>
                                                    <p class="mb-0 fw-medium"><a href="{{url('notifications')}}">New Message</a></p>
                                    ...
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                                <div>
                                                    <p class="mb-0 fw-medium"><a href="{{url('notifications')}}">Appointment Confirmed</a></p>
                                    ...
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                                <div>
                                                    <p class="mb-0 fw-medium"><a href="{{url('notifications')}}">Exclusive Offer</a></p>
                                ...
                                <div class="p-3 empty-header-item1 border-top">
                                    <div class="text-center">
                                        <a href="{{url('notifications')}}" class="link-primary text-decoration-underline">View All</a>
                                    </div>
                                </div>
                        ...
                        <li class="header-element dropdown">
                            ...
                            <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <img src="{{asset('build/assets/images/faces/22.jpg')}}" alt="img" class="avatar avatar-sm rounded-0">
                                    </div>
                                </div>
                            </a>
                            <!-- End::header-link|dropdown-toggle -->
                            <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                                <li><a class="dropdown-item d-flex align-items-center" href="{{url('profile')}}"><i class="bi bi-person fs-18 me-2 op-7"></i>Profile</a></li>
                                <li><a class="dropdown-item d-flex align-items-center" href="{{url('mail')}}"><i class="bi bi-envelope fs-16 me-2 op-7"></i>Inbox <span class="ms-auto badge bg-info">17</span></a></li>
                                <li><a class="dropdown-item d-flex align-items-center" href="{{url('todo-list')}}"><i class="bi bi-check-square fs-16 me-2 op-7"></i>Task Manager</a></li>
                                <li><a class="dropdown-item d-flex align-items-center" href="{{url('mail-settings')}}"><i class="bi bi-gear fs-16 me-2 op-7"></i>Settings</a></li>
                                <li><a class="dropdown-item d-flex align-items-center" href="{{url('chat')}}"><i class="bi bi-headset fs-18 me-2 op-7"></i>Support</a></li>
                                <li><a class="dropdown-item d-flex align-items-center" href="{{url('signin-cover')}}"><i class="bi bi-box-arrow-right fs-18 me-2 op-7"></i>Log Out</a></li>
                            </ul>
                        </li>
                        <!-- End::header-element -->
