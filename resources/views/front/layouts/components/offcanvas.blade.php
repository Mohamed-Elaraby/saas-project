            ...
            <div class="offcanvas-body">
                ...
                <div class="panel-body">
                    ...
                    <div class="tab-pane p-0 show active" id="side1">
                        ...
                        <a href="{{url('mail-settings')}}" class="text-primary">Mail Settings</a>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-1 mb-3">
                            ...
                            <a href="{{url('mail')}}" class="btn btn-sm btn-primary-light btn-icon btn-icon"><i class="ri-chat-1-line"></i></a>
                        </div>
                        <ul class="list-unstyled mb-0 mt-2">
                            ...
                            <div class="d-flex pos-relative">
                                ...
                                <img alt="avatar" class="shadow" src="{{asset('build/assets/images/faces/5.jpg')}}">
                                </div>
                            ...
                            <div class="d-flex pos-relative">
                                <a href="javascript:void(0)" class="link-overlap"></a>
                                <div class="main-img-user avatar d-none d-sm-block">
                                <img alt="avatar" class="shadow" src="{{asset('build/assets/images/faces/9.jpg')}}">
                                </div>
                                <div class="flex-grow-1 ms-2 fs-13">
                                <div class="d-flex align-items-center justify-content-between gap-1 mb-1">
                            ...
                            <div class="d-flex pos-relative">
                                <a href="javascript:void(0)" class="link-overlap"></a>
                                <div class="main-img-user avatar d-none d-sm-block">
                                <img alt="avatar" class="shadow" src="{{asset('build/assets/images/faces/8.jpg')}}">
                                </div>
                                <div class="flex-grow-1 ms-2 fs-13">
                                <div class="d-flex align-items-center justify-content-between gap-1 mb-1">
                            ...
                            <div class="d-flex pos-relative">
                                <a href="javascript:void(0)" class="link-overlap"></a>
                                <div class="main-img-user avatar d-none d-sm-block">
                                <img alt="avatar" class="shadow" src="{{asset('build/assets/images/faces/3.jpg')}}">
                                </div>
                                <div class="flex-grow-1 ms-2 fs-13">
                                <div class="d-flex align-items-center justify-content-between gap-1 mb-1">
                            ...
                            <div class="d-flex pos-relative">
                                <a href="javascript:void(0)" class="link-overlap"></a>
                                <div class="main-img-user avatar d-none d-sm-block">
                                <img alt="avatar" class="shadow" src="{{asset('build/assets/images/faces/10.jpg')}}">
                                </div>
                                <div class="flex-grow-1 ms-2 fs-13">
                                <div class="d-flex align-items-center justify-content-between gap-1 mb-1">
                        ...
                        <div class="text-end mt-2">
                            <a href="{{url('chat')}}" class="text-primary">View All</a>
                        </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-1 my-3">
                            ...
                            <a href="{{url('mail')}}" class="btn btn-sm btn-primary-light btn-icon btn-icon"><i class="ri-add-circle-line"></i></a>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-1 mb-3">
                            ...
                            <a href="{{url('contacts')}}" class="btn btn-sm btn-primary-light btn-icon btn-icon"><i class="ri-phone-line"></i></a>
                        </div>
                        <ul class="list-unstyled mb-0 mt-2">
                            <li class="mb-3">
                            <div class="d-flex pos-relative">
                                <a href="javascript:void(0)" class="link-overlap"></a>
                                <div class="main-img-user avatar d-none d-sm-block">
                                <img alt="avatar" class="shadow" src="{{asset('build/assets/images/faces/14.jpg')}}">
                                </div>
                                <div class="flex-grow-1 ms-2 fs-13">
                                <div class="d-flex align-items-center justify-content-between gap-1 mb-1">
                            ...
                            <div class="d-flex pos-relative">
                                ...
                                <div class="main-img-user avatar d-none d-sm-block">
                                <img alt="avatar" class="shadow" src="{{asset('build/assets/images/faces/7.jpg')}}">
                                </div>
                                <div class="flex-grow-1 ms-2 fs-13">
                                <div class="d-flex align-items-center justify-content-between gap-1 mb-1">
                            ...
                            <div class="d-flex pos-relative">
                                ...
                                data-bs-target="#videoModal"></a>
                                <div class="main-img-user avatar d-none d-sm-block">
                                <img alt="avatar" class="shadow" src="{{asset('build/assets/images/faces/4.jpg')}}">
                                </div>
                                <div class="flex-grow-1 ms-2 fs-13">
                                <div class="d-flex align-items-center justify-content-between gap-1 mb-1">
                            ...
                            <div class="d-flex pos-relative">
                                <a href="javascript:void(0)" class="link-overlap"></a>
                                <div class="main-img-user avatar d-none d-sm-block">
                                <img alt="avatar" class="shadow" src="{{asset('build/assets/images/faces/12.jpg')}}">
                                </div>
                                <div class="flex-grow-1 ms-2 fs-13">
                                <div class="d-flex align-items-center justify-content-between gap-1 mb-1">
                            ...
                            <div class="d-flex pos-relative">
                                <a href="javascript:void(0)" class="link-overlap"></a>
                                <div class="main-img-user avatar d-none d-sm-block">
                                <img alt="avatar" class="shadow" src="{{asset('build/assets/images/faces/13.jpg')}}">
                                </div>
                                <div class="flex-grow-1 ms-2 fs-13">
                                <div class="d-flex align-items-center justify-content-between gap-1 mb-1">
                        ...
                        <div class="svg-card overflow-hidden">
                            <img src="{{asset('build/assets/images/media/media-67.jpg')}}" alt="">
                        </div>
                        <h6 class="mt-3">Find out more !</h6>
                        <a href="{{url('mail-settings')}}" class="btn btn-outline-primary btn-block">Mail Settings</a>
                        </div>
                    </div>
                    <div class="tab-pane p-0" id="side2">
                        ...
                        <div class="text-center">
                            ...
                            <a href="{{url('profile-settings')}}" class="btn btn-block btn-outline-primary">Go To Profile Settings</a>
                        </div>
                        </div>
                    </div>
                    </div>
