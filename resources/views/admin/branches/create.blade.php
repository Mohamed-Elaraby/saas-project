                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.branches.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input name="display_name" type="text" class="form-control" id="display_name" placeholder="" value="{{ old('display_name') }}">
                                    </div>
                                    @error('display_name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input name="phone" class="form-control" id="phone" type="tel" placeholder="" value="{{ old('phone') }}">
                                    </div>
                                    @error('phone')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input name="building_number" type="text" class="form-control" id="building_number" placeholder="" value="{{ old('building_number') }}">
                                    </div>
