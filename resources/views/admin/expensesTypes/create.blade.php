...
@section('title', __('trans.create expenses type'))
                            ...
                            <form action="{{ route('admin.expensesTypes.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input name="name" type="text" class="form-control" id="expensesType_name" placeholder="" value="{{ old('name') }}">
                                    </div>
                                    @error('name')
