...
@section('title', __('trans.edit supplier'))
                            ...
                            <form action="{{ route('admin.suppliers.update', $supplier -> id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="name" type="text" class="form-control" id="supplier_name" placeholder="" value="{{ $supplier -> name }}">
                                    </div>
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="phone" type="text" class="form-control" id="phone" placeholder="" value="{{  $supplier -> phone }}">
                                    </div>
                                    @error('phone')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="building_number" type="text" class="form-control" id="building_number" value="{{ $supplier -> building_number }}">
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="street_name" type="text" class="form-control" id="street_name" placeholder="" value="{{ $supplier -> street_name }}">
                                    </div>
                                    @error('street_name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="district" type="text" class="form-control" id="district" placeholder="" value="{{ $supplier -> district }}">
                                    </div>
                                    @error('district')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="city" type="text" class="form-control" id="city" placeholder="" value="{{ $supplier -> city }}">
                                    </div>
                                    @error('city')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="country" type="text" class="form-control" id="country" placeholder="" value="{{ $supplier -> country }}">
                                    </div>
                                    @error('country')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="postal_code" type="text" class="form-control" id="postal_code" placeholder="" value="{{ $supplier -> postal_code }}">
                                    </div>
                                    @error('postal_code')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="vat_number" type="text" class="form-control" id="vat_number" placeholder="" value="{{ $supplier -> vat_number }}">
                                    </div>
                                    @error('vat_number')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
