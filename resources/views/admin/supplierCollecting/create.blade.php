...
@section('title', __('trans.create supplier collecting'))
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-header justify-content-between">
                            <div class="card-title">
                                {{ __('trans.create supplier collecting') . ' ' . __('trans.from') . ' ' . $supplier -> name }}
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.supplierCollecting.store') }}" method="POST">
                                ...
                                <div class="col-xl-12 mb-3">
                                    <label for="collecting_date" class="form-label">{{ __('trans.collecting date') }}</label>
                                    <input name="collecting_date" type="text" class="form-control" id="collecting_date">
                                </div>
                                ...
                                <button class="btn btn-primary" type="submit">{{ __('trans.collect') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
