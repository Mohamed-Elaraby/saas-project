...
<head>
    ...
    <style>
        ...
        #client_info_table, #client_info_table th, #client_info_table tr, #client_info_table td{
            border: none;
            text-align: left;
        }

        /* Table styles */
        #client_transaction_table  {
            width: 100%;
            border-collapse: collapse;
        }

        #client_transaction_table th, td {
            border: 1px solid #ccc;
            padding: 8px;
            text-align: left;
        }

        #client_transaction_table th {
            background-color: #f2f2f2;
        }
        @if( LaravelLocalization::getCurrentLocale() == 'ar')

        #client_info_table, #client_info_table th, #client_info_table td,
        #client_transaction_table, #client_transaction_table th, #client_transaction_table td
        {
            text-align: right;
            direction: rtl;
        }
...
<main>
    <table id="client_info_table">
        ...
        <tr>
            ...
            <td>: {{ $client -> balance . ' ' . \App\Traits\SettingTrait::getSetting()->currency}}</td>
        </tr>
        <tr>
    ...
    <table id="client_transaction_table">
        ...
        @foreach ($client_transaction as $transaction)
            <tr>
                ...
                <td>{{ $transaction -> client_balance }}</td>
            </tr>
        @endforeach
    </table>
</main>
