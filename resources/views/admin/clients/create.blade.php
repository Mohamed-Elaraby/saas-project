...
@section('title', __('trans.create client'))
                            ...
                            <form action="{{ route('admin.clients.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="name" type="text" class="form-control" id="client_name" placeholder="" value="{{ old('name') }}">
                                    </div>
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="employer" type="text" class="form-control" id="employer" placeholder="" value="{{ old('employer') }}">
                                    </div>
                                    @error('employer')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="how_you_now_us" type="text" class="form-control" id="how_you_now_us" placeholder="" value="{{ old('how_you_now_us') }}">
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input form-checked-outline form-checked-success" type="radio" name="other_car_status" id="other_car_status" value="1">
                                        <label class="form-check-label" for="other_car_status">
                                            {{ __('trans.yes') }}
                                        </label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input form-checked-outline form-checked-danger" type="radio" name="other_car_status" id="other_car_status" value="0" checked="">
                                        <label class="form-check-label" for="other_car_status">
                                            {{ __('trans.no') }}
                                        </label>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="other_car" type="text" class="form-control" id="other_car" placeholder="" value="{{ old('other_car') }}" disabled="">
                                    </div>
