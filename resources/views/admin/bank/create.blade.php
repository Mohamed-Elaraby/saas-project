...
@section('title', __('trans.operation on the bank'))
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-header justify-content-between">
                            <div class="card-title">
                                {{ __('trans.create') . ' ' . __('trans.operation on the bank') . ' ( ' . $branch -> display_name . ' )' }}
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.bank.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="amount_paid" class="form-label fs-14 text-dark">{{ __('trans.amount paid in bank') }}</label>
