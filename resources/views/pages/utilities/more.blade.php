                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-inline p-2 bg-primary rounded m-1">d-inline</div>
                                ...
                                <div class="col-xl-6">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body d-sm-flex">
                                            <div class="opacity-100 p-3 m-2 bg-primary fw-bold rounded">100%
                                            </div>
                                            <div class="opacity-75 p-3 m-2 bg-primary fw-bold rounded">75%</div>
                                            <div class="opacity-50 p-3 m-2 bg-primary fw-bold rounded">50%</div>
                                            <div class="opacity-25 p-3 m-2 bg-primary fw-bold rounded">25%</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="float-start p-2 bg-primary rounded mb-2">Float start</div><br>
                                            <div class="float-end p-2 bg-primary rounded">Float end</div><br>
                                            <div class="float-none p-2 bg-primary rounded mt-4">Don't float</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-12">
