                                    ...
                                    <div class="row">
                                            ...
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="card-body nft-body">
                                                    ...
                                                    <div class="d-flex flex-wrap text-fixed-white align-items-center gap-2">
                                                        ...
                                                        <div class="">
                                                            <p class="mb-0 fw-medium">DigitalErgo NFT</p>
                                                            <p class="fs-12 op-8 mb-0">@digitalergos112</p>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="text-success fw-medium">
                                                                0.34ETH
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="bottom-left"></div>
                                                <div class="bottom-right"></div>
                                                <img src="{{asset('build/assets/images/nft-images/11.png')}}" class="card-img-top nft-image" alt="...">
                                                <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                    <div class="flex-fill">
                                                        <button class="btn btn-sm btn-icon btn-success rounded-pill btn-wave">
                                                            <i class="ri-heart-fill"></i>
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="bottom-left"></div>
                                                <div class="bottom-right"></div>
                                                <img src="{{asset('build/assets/images/nft-images/12.png')}}" class="card-img-top nft-image" alt="...">
                                                <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                    <div class="flex-fill">
                                                        <button class="btn btn-sm btn-icon btn-success rounded-pill btn-wave">
                                                            <i class="ri-heart-fill"></i>
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="bottom-left"></div>
                                                <div class="bottom-right"></div>
                                                <img src="{{asset('build/assets/images/nft-images/10.png')}}" class="card-img-top nft-image" alt="...">
                                                <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                    <div class="flex-fill">
                                                        <button class="btn btn-sm btn-icon btn-success rounded-pill btn-wave">
                                                            <i class="ri-heart-fill"></i>
                                                ...
                                                <div class="card-body nft-body">
                                                    ...
                                                    <div class="d-flex flex-wrap text-fixed-white align-items-center gap-2">
                                                        ...
                                                        <div class="">
                                                            <p class="mb-0 fw-medium">Floral NFT</p>
                                                            <p class="fs-12 op-8 mb-0">@bloom002</p>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="text-success fw-medium">
                                                                0.18ETH
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="bottom-left"></div>
                                                <div class="bottom-right"></div>
                                                <img src="{{asset('build/assets/images/nft-images/13.png')}}" class="card-img-top nft-image" alt="...">
                                                <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                    <div class="flex-fill">
                                                        <button class="btn btn-sm btn-icon btn-success rounded-pill btn-wave">
                                                            <i class="ri-heart-fill"></i>
                                                ...
                                                <div class="card-body nft-body">
                                                    ...
                                                    <p class="fw-medium text-fixed-white">Space Abstract - NFT</p>
                                                    <div class="d-flex flex-wrap text-fixed-white align-items-center gap-2">
                                                        <span class="avatar avatar-rounded avatar-md">
                                                            <img src="{{asset('build/assets/images/faces/9.jpg')}}" alt="">
                                                        </span>
                                                        <div class="">
                                                            <p class="mb-0 fw-medium">Goe NFT</p>
                                                            <p class="fs-12 op-8 mb-0">@goe215</p>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="text-success fw-medium">
                                                                0.18ETH
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="bottom-left"></div>
                                                <div class="bottom-right"></div>
                                                <img src="{{asset('build/assets/images/nft-images/14.png')}}" class="card-img-top nft-image" alt="...">
                                                <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                    <div class="flex-fill">
                                                        <button class="btn btn-sm btn-icon btn-success rounded-pill btn-wave">
                                                            <i class="ri-heart-fill"></i>
                                            ...
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="card-body nft-body">
                                                    ...
                                                    <div class="d-flex flex-wrap text-fixed-white align-items-center gap-2">
                                                        ...
                                                        <div class="">
                                                            <p class="mb-0 fw-medium">Floral NFT</p>
                                                            <p class="fs-12 op-8 mb-0">@bloom156</p>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="text-success fw-medium">
                                                                0.63ETH
                                            ...
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="card-body nft-body">
                                                    ...
                                                    <div class="d-flex flex-wrap text-fixed-white align-items-center gap-2">
                                                        ...
                                                        <div class="">
                                                            <p class="mb-0 fw-medium">DigitalErgo NFT</p>
                                                            <p class="fs-12 op-8 mb-0">@Ergos002</p>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="text-success fw-medium">
                                                                0.26ETH
                                            ...
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="card-body nft-body">
                                                    ...
                                                    <div class="d-flex flex-wrap text-fixed-white align-items-center gap-2">
                                                        ...
                                                        <div class="">
                                                            <p class="mb-0 fw-medium">DigitalErgo NFT</p>
                                                            <p class="fs-12 op-8 mb-0">@ergos032</p>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="text-success fw-medium">
                                                                1.45ETH
                                            ...
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="card-body nft-body">
                                                    ...
                                                    <div class="d-flex flex-wrap text-fixed-white align-items-center gap-2">
                                                        ...
                                                        <div class="">
                                                            <p class="mb-0 fw-medium">DigitalErgo NFT</p>
                                                            <p class="fs-12 op-8 mb-0">@ergos052</p>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="text-success fw-medium">
                                                                0.85ETH
                                            ...
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="card-body nft-body">
                                                    ...
                                                    <div class="d-flex flex-wrap text-fixed-white align-items-center gap-2">
                                                        ...
                                                        <div class="">
                                                            <p class="mb-0 fw-medium">DigitalErgo NFT</p>
                                                            <p class="fs-12 op-8 mb-0">@ergos005</p>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="text-success fw-medium">
                                                                0.15ETH
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="card-body nft-body">
                                                    ...
                                                    <p class="fw-medium text-fixed-white">Fluid - NFT</p>
                                                    <div class="d-flex flex-wrap text-fixed-white align-items-center gap-2">
                                                        <span class="avatar avatar-rounded avatar-md">
