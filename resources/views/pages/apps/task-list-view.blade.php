                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="p-3 border-bottom gap-3 d-flex border-block-end-dashed">
                                        ...
                                        <div class="flex-fill">
                                            ...
                                            <div class="pb-0 mt-0"> 
                                                <div> 
                                                    <h4 class="fs-18 fw-medium mb-2 d-flex align-items-center justify-content-between"><span class="count-up" data-count="457">457</span><span class="badge bg-secondary fw-normal ms-2 fs-10 align-middle">
                                                        2,457
                                                    </span> </h4> 
                                                    <p class="text-muted fs-11 mb-0 lh-1">
                                                        <span class="text-danger me-1 fw-medium">
                                        ...
                                        <table class="table text-nowrap">
                                            ...
                                            <tbody>
                                                <tr class="task-list">
                                                    ...
                                                    <td>
                                                        <span class="fw-medium">Redesign E-commerce Pages.</span>
                                                    </td>
                                                    <td>
                                                        <span class="fw-medium">TSK - 31</span>
                                                    </td>
                                                    <td>
                                                        18-12-2023
                                                    </td>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-primary-light btn-icon btn-sm"><i class="ri-edit-line"></i></button>
                                                ...
                                                <tr class="task-list">
                                                    ...
                                                    <td>
                                                        <span class="fw-medium">Implementation of New Pages.</span>
                                                    </td>
                                                    <td>
                                                        <span class="fw-medium">TSK - 34</span>
                                                    </td>
                                                    <td>
                                                        06-12-2023
                                                    </td>
                                                ...
                                                <tr class="task-list">
                                                    ...
                                                    <td>
                                                        <span class="fw-medium">TSK - 51</span>
                                                    </td>
                                                    <td>
                                                        12-12-2023
                                                    </td>
                                                ...
                                                <tr class="task-list">
                                                    <td class="task-checkbox"><input class="form-check-input" type="checkbox" value="" aria-label="..."></td>
                                                    <td>
                                                        <span class="fw-medium">Design and update project</span>
                                                    </td>
                                                    <td>
                                                        <span class="fw-medium">TSK - 44</span>
                                                    </td>
                                                    <td>
                                                        19-12-2023
                                                    </td>
                                                ...
                                                <tr class="task-list">
                                                    <td class="task-checkbox"><input class="form-check-input" type="checkbox" value="" aria-label="..." checked></td>
                                                    <td>
                                                        <span class="fw-medium">Integrate Wireframes for New Project</span>
                                                    </td>
                                                    <td>
                                                        <span class="fw-medium">TSK - 56</span>
                                                    </td>
                                                    <td>
                                                        08-12-2023
                                                    </td>
                                                ...
                                                <tr class="task-list">
                                                    <td class="task-checkbox"><input class="form-check-input" type="checkbox" value="" aria-label="..." checked></td>
                                                    <td>
                                                        <span class="fw-medium">Adding policies in main Landing page</span>
                                                    </td>
                                                    <td>
                                                        <span class="fw-medium">TSK - 37</span>
                                                    </td>
                                                    <td>
                                                        12-12-2023
                                                    </td>
                                                ...
                                                <tr class="task-list">
                                                    <td class="task-checkbox"><input class="form-check-input" type="checkbox" value="" aria-label="..."></td>
                                                    <td>
                                                        <span class="fw-medium">Implemetation of Reponsive Tables</span>
                                                    </td>
                                                    <td>
                                                        <span class="fw-medium">TSK - 53</span>
                                                    </td>
                                                    <td>
                                                        20-12-2023
                                                    </td>
                                                ...
                                                <tr class="task-list">
                                                    <td class="task-checkbox"><input class="form-check-input" type="checkbox" value="" aria-label="..." checked></td>
                                                    <td>
                                                        <span class="fw-medium">Plugin Implementations</span>
                                                    </td>
                                                    <td>
                                                        <span class="fw-medium">TSK - 40</span>
                                                    </td>
                                                    <td>
                                                        30-12-2023
                                                    </td>
                                                ...
                                                <tr class="task-list">
                                                    <td class="task-checkbox"><input class="form-check-input" type="checkbox" value="" aria-label="..."></td>
                                                    <td>
                                                        <span class="fw-medium">Bug fixing Functinality</span>
                                                    </td>
                                                    <td>
                                                        <span class="fw-medium">TSK - 46</span>
                                                    </td>
                                                    <td>
                                                        16-12-2023
                                                    </td>
                                                ...
                                                <tr class="task-list">
                                                    <td class="task-checkbox"><input class="form-check-input" type="checkbox" value="" aria-label="..."></td>
                                                    <td>
                                                        <span class="fw-medium">Designing Sales Dashboard</span>
                                                    </td>
                                                    <td>
                                                        <span class="fw-medium">TSK - 32</span>
                                                    </td>
                                                    <td>
                                                        08-12-2023
                                                    </td>
