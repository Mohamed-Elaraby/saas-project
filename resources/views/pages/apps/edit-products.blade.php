                                        ...
                                        <div class="row gx-5">
                                                ...
                                                <div class="shadow-none mb-0 border-0">
                                                    <div class="card-body p-0">
                                                        <div class="row gy-3">
                                                            ...
                                                            <div class="col-xl-12">
                                                                <label for="product-category-add" class="form-label">Product
                                                                    Category</label>
                                                            ...
                                                            <div class="col-xl-12">
                                                                ...
                                                                <textarea class="form-control" id="product-description-add"
                                                                    rows="2">Wireless Earphones with Bluetooth Connectivity and Dual Modes, flexible.</textarea>
                                                            ...
                                                            <div class="col-xl-12">
                                                                <p class="fw-medium fs-14 mb-2">Product Features :</p>
                                            ...
                                            <div class="col-xxl-6 col-xl-12 col-lg-12 col-md-6">
                                                <div class="shadow-none mb-0 border-0">
                                                    <div class="card-body p-0">
                                                        <div class="row gy-4">
                                                            <p class="fw-medium fs-14 mb-0">Specifications :</p>
                                                            <div class="row mx-0 mt-0 gy-2">
                                                                ...
                                                                <div class="col-xl-6 mt-xl-2">
                                                                    ...
                                                                    <select class="form-control" data-trigger name="product-brand-add"
                                                                        ...
                                                                        <option value="">Select</option>
                                                                        <option value="BoatZ">BoatZ</option>
                                                                        <option value="Lunetta">Lunetta</option>
                                                                        <option value="Ekass">Ekass</option>
                                                                        <option value="Sony" selected>Sony</option>
                                                                        <option value="Rockets">Rockets</option>
                                                                        <option value="Eddie's">Eddie's</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-xl-6">
                                                                ...
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <input type="text" class="form-control" id="product-type"
                                                                        placeholder="Type" value="Wireless">
                                                                </div>
                                                                <div class="col-xl-6">
                                                                    <label for="product-discount" class="form-label">Item Weight</label>
                                                                    <input type="text" class="form-control" id="product-discount1"
                                                                        placeholder="Weight in gms" value="250gms">
                                                                </div>
                                                                <div class="col-xl-6">
                                                                    <label for="product-quantity-add" class="form-label">Quantity</label>
                                                                    <input type="number" class="form-control" id="product-quantity-add"
                                                                        placeholder="Quantity" value="1">
                                                                </div>
                                                            </div>
                                                            <p class="fw-medium fs-14 mb-0">Pricing :</p>
                                                            <div class="row mx-0 mt-0">
                                                                <div class="col-xl-4 mt-xl-2">
                                                                    <label for="product-actual-price" class="form-label">Actual
                                                                        Price</label>
                                                                    <input type="text" class="form-control" id="product-actual-price" value="$799.09"
                                                                ...
                                                                <div class="col-xl-4 mt-xl-2">
                                                                    <label for="product-dealer-price" class="form-label">Dealer
                                                                        ...
                                                                        Price</label>
                                                                    <input type="text" class="form-control" id="product-dealer-price" value="$840.00"
                                                                        placeholder="Dealer Price">
                                                                </div>
                                                                <div class="col-xl-4 mt-xl-2">
                                                                    <label for="product-discount" class="form-label">Discount</label>
                                                                    <input type="text" class="form-control" id="product-discount" value="0.5%"
                                                            ...
                                                            <div class="row mx-0">
                                                                <div class="col-xl-12 product-documents-container">
                                                                    ...
                                                                    <label class="form-label op-5 mt-3">Minimum 0f 6 images are need to be
                                                                        uploaded,make sure the image size match the proper background size
                                                                        and all images should be uniformly maintained with width and height
                                                                        to the image container,image size should not exceed 2MB,once
                                                                        uploaded to change the image you need to wait minimum of 24hrs.
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <p class="fw-medium mb-2 fs-14">Availability :</p>
                                                            <div class="row mx-0">
                                                                <div class="col-xl-12">
