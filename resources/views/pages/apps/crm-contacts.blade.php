                ...
                <div class="container-fluid">
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3 pb-3">
                                    <div class="card-title">
                                        Contacts<span class="badge bg-light text-default rounded ms-1 fs-12 align-middle">17</span>
                                    </div>
                                        ...
                                        <table class="table text-nowrap border-top">
                                            ...
                                            <tbody>
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                ...
                                                                role="button" aria-controls="offcanvasExample"><span class="d-block fw-medium">Alison</span></a>
                                                                <span class="d-block text-muted fs-11" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary" title="Last Contacted"><i class="ri-time-line me-1 align-middle"></i>13, Jul 2023 - 6:15PM</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted"></i>Alison2571@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>Nexis Technologies</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted"></i>4777-54755-771</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Social Media
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample"><span class="d-block fw-medium">Noel</span></a>
                                                                <span class="d-block text-muted fs-11" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary" title="Last Contacted"><i class="ri-time-line me-1 align-middle"></i>21, Jul 2023 - 08:16AM</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted"></i>Noel289@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>MarbelsIntech solution</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted"></i>8741-8547-5661</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Direct mail
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample"><span class="d-block fw-medium">Sandy</span></a>
                                                                <span class="d-block text-muted fs-11" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary" title="Last Contacted"><i class="ri-time-line me-1 align-middle"></i>14, Aug 2023 - 04:33PM</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted"></i>Sandy888@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>Classic Marketing</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted"></i>9874-7742-3220</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Blog Articles
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample"><span class="d-block fw-medium">Alexia</span></a>
                                                                <span class="d-block text-muted fs-11" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary" title="Last Contacted"><i class="ri-time-line me-1 align-middle"></i>28, Aug 2023 - 09:47AM</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted"></i>Alexia290@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>Indusakis Services</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted"></i>1200-2520-5884</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Affiliates
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample"><span class="d-block fw-medium">Silvia</span></a>
                                                                <span class="d-block text-muted fs-11" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary" title="Last Contacted"><i class="ri-time-line me-1 align-middle"></i>26, Sep  2023 - 01:51PM</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted"></i>Silvia96@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>Internatinal Indus</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted"></i>8741-4882-9871</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Organic search 
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample"><span class="d-block fw-medium">Noel Lucas</span></a>
                                                                <span class="d-block text-muted fs-11" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary" title="Last Contacted"><i class="ri-time-line me-1 align-middle"></i>08, Sep 2023 - 01:52PM</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted"></i>noellucas471@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>Convention Prime</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted"></i>8821-5785-5742</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Social media 
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample"><span class="d-block fw-medium">Stuart</span></a>
                                                                <span class="d-block text-muted fs-11" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary" title="Last Contacted"><i class="ri-time-line me-1 align-middle"></i>06, Sep 2023 - 08:56AM</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted"></i>Stuart78@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>Pride Corporation</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted"></i>3582-8151-8452</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Blog Articles
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample"><span class="d-block fw-medium">Myra</span></a>
                                                                <span class="d-block text-muted fs-11" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary" title="Last Contacted"><i class="ri-time-line me-1 align-middle"></i>23, Oct 2023 - 09:54PM</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted"></i>Myra220@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>Manish's Manufactures</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted"></i>4711-1242-0021</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Organic search
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample"><span class="d-block fw-medium">Juliana</span></a>
                                                                <span class="d-block text-muted fs-11" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary" title="Last Contacted"><i class="ri-time-line me-1 align-middle"></i>04, Nov 2023 - 11:25AM</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted"></i>Juliana289@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>Travels Services</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted"></i>8451-5484-8885</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Affiliates
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample"><span class="d-block fw-medium">George</span></a>
                                                                <span class="d-block text-muted fs-11" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary" title="Last Contacted"><i class="ri-time-line me-1 align-middle"></i>14, Nov 2023 - 08:55AM</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted"></i>George116@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>HyraKen Technologies</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted"></i>8744-5811-5874</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Direct mail
                    ...
                    aria-labelledby="offcanvasExample">
                        <div class="offcanvas-body p-0">
                            <div class="d-sm-flex align-items-top p-4 main-profile-cover">
                                <div>
                                    <span class="avatar avatar-xl  online me-3">
                                        <img src="{{asset('build/assets/images/faces/4.jpg')}}" alt="">
                                    </span>
                                </div>
                                <div class="flex-fill main-profile-info">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h6 class="fw-bold mb-1 text-fixed-white">Alison Lia</h6>
                                    ...
                                    <p class="fs-12 text-fixed-white mb-4 op-5">  
                                        <span class="me-3"><i class="ri-building-line me-1 align-middle"></i>New York</span> 
                                        <span><i class="ri-map-pin-line me-1 align-middle"></i>United States</span> 
                                    </p>
                                    <div class="d-flex mb-0">
                                        <div class="me-4">
                                            <p class="fw-semibold fs-20 text-fixed-white text-shadow mb-0">245</p>
                                            <p class="mb-0 fs-11 op-5 text-fixed-white">Deals</p>
                                        </div>
                                        <div class="me-4">
                                            <p class="fw-semibold fs-20 text-fixed-white text-shadow mb-0">$25.2k</p>
                                            <p class="mb-0 fs-11 op-5 text-fixed-white">Contributions</p>
                                        </div>
                                        <div class="me-4">
                                            <p class="fw-semibold fs-20 text-fixed-white text-shadow mb-0">$11.43k</p>
                            ...
                            <div class="p-4 border-bottom border-block-end-dashed">
                                <div class="mb-0">
                                    ...
                                    <p class="text-muted fs-13 op-8 mb-0">
                                        I am <b class="text-default">Alison Lisa,</b> a seasoned entrepreneur with over two decades of experience in the tech industry. Currently, I serve as the CEO and founder of InnovateX Solutions, a cutting-edge software development firm specializing in AI-driven solutions for businesses worldwide.
                                    </p>
                                </div>   
                            </div>  
                            ...
                            <div class="p-4 border-bottom border-block-end-dashed">
                                ...
                                <div class="">
                                    <div class="d-flex align-items-center mb-2">
                                        <div class="me-2">
                                            <span class="avatar avatar-sm  bg-light text-muted">
                                                <i class="ri-mail-line align-middle fs-14"></i>
                                            </span>
                                        </div>
                                        <div class="fs-14">
                                            alisonlisa4815@gmail.com
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center mb-2">
                                        <div class="me-2">
                                    ...
                                    <div class="d-flex align-items-center mb-0">
                                        ...
                                        <div class="fs-14">
                                            84/A-23 Main Street, Anytown, United States, USA, 20071
                                        </div>
                                    </div>
                                </div>
                            </div>
