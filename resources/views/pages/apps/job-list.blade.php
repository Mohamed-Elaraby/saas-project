                                        ...
                                        <table class="table table-hover text-nowrap">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <a href="javascript:void(0);" class="fw-medium mb-0">SwiftSynergy.pvt.ltd</a>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Development
                                                    ...
                                                    <td>10</td>
                                                    <td>15</td>
                                                    <td><span class="badge bg-primary-transparent">Approved</span></td>
                                                    <td>Full Time</td>
                                                    <td>
                                                        18 Dec, 2023
                                                    </td>
                                                    <td><span class="badge bg-primary-transparent"><i class="bi bi-clock me-1"></i>26 Jan, 2024</span></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <a href="javascript:void(0);" class="fw-medium mb-0">Horizon Enterprises</a>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Design
                                                    ...
                                                    <td><span class="badge bg-danger-transparent"><i class="bi bi-clock me-1"></i>26 Feb, 2024</span></td>
                                                    <td>
                                                        <a href="{{url('job-details')}}" class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light">
                                                            <i class="ri-eye-line"></i>
                                                        </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge bg-primary-transparent"><i class="bi bi-clock me-1"></i>08 Jan, 2024</span></td>
                                                    <td>
                                                        <a href="{{url('job-details')}}" class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light">
                                                            <i class="ri-eye-line"></i>
                                                        </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <a href="javascript:void(0);" class="fw-medium mb-0">Quantum Innovations Inc.</a>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Marketing
                                                    ...
                                                    <td><span class="badge bg-primary-transparent"><i class="bi bi-clock me-1"></i>16 Jan, 2024</span></td>
                                                    <td>
                                                        <a href="{{url('job-details')}}" class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light">
                                                            <i class="ri-eye-line"></i>
                                                        </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge bg-primary-transparent"><i class="bi bi-clock me-1"></i>23 Nov, 2023</span></td>
                                                    <td>
                                                        <a href="{{url('job-details')}}" class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light">
                                                            <i class="ri-eye-line"></i>
                                                        </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge bg-danger-transparent"><i class="bi bi-clock me-1"></i>19, Dec 2023</span></td>
                                                    <td>
                                                        <a href="{{url('job-details')}}" class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light">
                                                            <i class="ri-eye-line"></i>
                                                        </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge bg-primary-transparent"><i class="bi bi-clock me-1"></i>08, Nov 2023</span></td>
                                                    <td>
                                                        <a href="{{url('job-details')}}" class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light">
                                                            <i class="ri-eye-line"></i>
                                                        </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge bg-primary-transparent"><i class="bi bi-clock me-1"></i>30, Nov 2023</span></td>
                                                    <td>
                                                        <a href="{{url('job-details')}}" class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light">
                                                            <i class="ri-eye-line"></i>
                                                        </a>
