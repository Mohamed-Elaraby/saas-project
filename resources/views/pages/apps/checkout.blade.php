...
@section('content')
            ...
            <div class="main-content app-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-9">
                            <ul class="nav nav-tabs tab-style-1 d-sm-flex d-block mb-4 bg-primary-transparent gap-3" id="myTab1" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="order-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="order-tab" aria-selected="true"><i
                                            class="ri-truck-line me-2 align-middle fs-13"></i>Shipping</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="confirmed-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="confirmed-tab" aria-selected="false"><i
                                            class="ri-user-3-line me-2 align-middle fs-13"></i>Personal Details</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="shipped-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="shipped-tab" aria-selected="false"><i
                                            class="ri-bank-card-line me-2 align-middle fs-13"></i>Payment</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="delivered-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="delivered-tab" aria-selected="false"><i
                                            class="ri-checkbox-circle-line me-2 align-middle fs-13"></i>Confirmation</button>
                                </li>
                            </ul>
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="p-4">
                                                ...
                                                <div class="fs-15 fw-medium d-sm-flex d-block align-items-center justify-content-between mb-3">
                                                    ...
                                                    <div class="mt-sm-0 mt-2">
                                                        <button type="button" class="btn btn-outline-primary btn-sm"  data-bs-toggle="modal" data-bs-target="#modal-new-address"><i class="ri-add-line me-1 align-middle fs-14 fw-medium d-inline-block"></i>Add Shipping Address</button>
                                                        <div class="modal"  id="modal-new-address" tabindex="-1" aria-labelledby="modal-new-address" aria-hidden="true">
                                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h6 class="modal-title" id="staticBackdropLabel1">New Address
                                                                        </h6>
                                                                        ...
                                                                        <div class="row gy-4 mb-4">
                                                                            <div class="col-xl-6">
                                                                                <div class="form-floating">
                                                                                    <input type="text" class="form-control" id="fullname-add" placeholder="Name">
                                                                                    <label for="fullname-add">Full Name</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-xl-6">
                                                                                <div class="form-floating">
                                                                                    <input type="email" class="form-control" id="email-add" placeholder="name@example.com">
                                                                                    <label for="email-add">Email</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-xl-6">
                                                                                <div class="form-floating">
                                                                                    <input type="email" class="form-control is-valid" id="phoneno-add" placeholder="1234-XX-XXXX">
                                                                                    <label for="phoneno-add">Phone No</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-xl-6">
                                                                                <div class="form-floating">
                                                                                    <textarea class="form-control" placeholder="Address Here" id="address-add"></textarea>
                                                                            ...
                                                                            <div class="col-xl-12">
                                                                                <div class="row gy-2">
                                                                                    <div class="col-xl-3">
                                                                                        <div class="form-floating">
                                                                                            <input type="text" class="form-control is-valid" id="pincode-add" placeholder="Name">
                                                                                            <label for="pincode-add">Pin Code</label>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-xl-3">
                                                                                        <div class="form-floating">
                                                                                            <input type="text" class="form-control" id="city-add" placeholder="Name">
                                                                                            <label for="city-add">City</label>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-xl-3">
                                                                                        <div class="form-floating">
                                                                                            <input type="text" class="form-control" id="state-add" placeholder="Name">
                                                                                            <label for="state-add">State</label>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-xl-3">
                                                                                        <div class="form-floating">
                                                                                            <input type="text" class="form-control" id="country-add" placeholder="Name">
                                                    ...
                                                    <div class="col-xxl-6">
                                                        <div class="card-body border">
                                                            <div class="d-sm-flex d-block align-items-center justify-content-between mb-2">
                                                                <div class="text-primary">Shipping Address <span class="text-default">(Default)</span>:</div>
                                                                <div class="mt-sm-0 mt-2">
                                                                    <a href="" class="fs-14 btn btn-sm btn-secondary-transparent" data-bs-toggle="modal" data-bs-target="#modal-edit-address"><i></i>Edit Address</a>
                                                                    <div class="modal"  id="modal-edit-address" tabindex="-1" aria-labelledby="modal-edit-address" aria-hidden="true">
                                                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h6 class="modal-title" id="staticBackdropLabel2">Edit Address
                                                                                    </h6>
                                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                                </div>
                                                                                <div class="modal-body">
                                                                                    <div class="row gy-3">
                                                                                        <div class="col-xl-6">
                                                                                            ...
                                                                                            <input type="text" class="form-control" id="fullname-new" placeholder="Full Name" value="Alice Wills">
                                                                                        </div>
                                                                                        <div class="col-xl-6">
                                                                                            <label for="email-new" class="form-label">Email</label>
                                                                                            <input type="email" class="form-control" id="email-new" placeholder="email" value="alicewills123@mail.com">
                                                                                        </div>
                                                                                        <div class="col-xl-6">
                                                                                            <label for="phonenumber-new" class="form-label">Phone Number</label>
                                                                                            <input type="text" class="form-control" id="phonenumber-new" placeholder="Phone" value="(121) 145 4624">
                                                                                        </div>
                                                                                        <div class="col-xl-6">
                                                                                            <label for="address-new" class="form-label">Address</label>
                                                                                            <input type="text" class="form-control" id="address-new" placeholder="Address" value="34A/45-354, B-Block, PNN Street">
                                                                                        </div>
                                                                                        <div class="col-xl-12">
                                                                                            <div class="row">
                                                                                                <div class="col-xl-3">
                                                                                                    <label for="pincode-new" class="form-label">Pincode</label>
                                                                                                    <input type="number" class="form-control" id="pincode-new" placeholder="Pinicode" value="120000">
                                                                                                </div>
                                                                                                <div class="col-xl-3">
                                                                                                    <label for="city-new" class="form-label">City</label>
                                                                                                    <input type="text" class="form-control" id="city-new" placeholder="City" value="AnyTown">
                                                                                                </div>
                                                                                                <div class="col-xl-3">
                                                                                                    <label for="state-new" class="form-label">State</label>
                                                                                                    <input type="text" class="form-control" id="state-new" placeholder="State" value="New California, Texas">
                                                                                                </div>
                                                                                                <div class="col-xl-3">
                                                                                                    <label for="country-new" class="form-label">Country</label>
                                                                                                    <input type="text" class="form-control" id="country-new" placeholder="Country" value="USA">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                            ...
                                                            <div class="ps-3">
                                                                <div>Alice Wills</div>
                                                                <div>Mail: <span class="fs-13 op-8">alicewills123@mail.com</span></div>
                                                                <div>Phone: <span class="fs-13 op-8">(121) 145 4624</span></div>
                                                                <div>Address: <span class="fs-13 op-8">34A/45-354, B-Block, PNN Street, Anytown</span></div>
                                                                <div><span class="fs-13 op-8">New California, Texas,USA, 1200000.</span></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xxl-6">
                                                        <div class="card-body border">
                                                            <div class="d-sm-flex d-block align-items-center justify-content-between mb-2">
                                                                <div class="text-primary">Billing Address :</div>
                                                                <div class="mt-sm-0 mt-2">
                                                                    <a href="" class="fs-14 btn btn-sm btn-secondary-transparent" data-bs-toggle="modal" data-bs-target="#modal-editbill-address"><i></i>Edit Address</a>
                                                                    <div class="modal"  id="modal-editbill-address" tabindex="-1" aria-labelledby="modal-editbill-address" aria-hidden="true">
                                                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h6 class="modal-title" id="staticBackdropLabel3">Edit Address
                                                                                    </h6>
                                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                                </div>
                                                                                <div class="modal-body">
                                                                                    <div class="row gy-3">
                                                                                        <div class="col-xl-6">
                                                                                            <label for="fullname-new1" class="form-label">Full Name</label>
                                                                                            <input type="text" class="form-control" id="fullname-new1" placeholder="Full Name" value="Alice Wills">
                                                                                        </div>
                                                                                        <div class="col-xl-6">
                                                                                            <label for="email-new1" class="form-label">Email</label>
                                                                                            <input type="email" class="form-control" id="email-new1" placeholder="email" value="alicewills123@mail.com">
                                                                                        </div>
                                                                                        <div class="col-xl-6">
                                                                                            <label for="phonenumber-new1" class="form-label">Phone Number</label>
                                                                                            <input type="text" class="form-control" id="phonenumber-new1" placeholder="Phone" value="(121) 145 4624">
                                                                                        </div>
                                                                                        <div class="col-xl-6">
                                                                                            <label for="address-new1" class="form-label">Address</label>
                                                                                            <input type="text" class="form-control" id="address-new1" placeholder="Address" value="34A/45-354, B-Block, PNN Street">
                                                                                        </div>
                                                                                        <div class="col-xl-12">
                                                                                            <div class="row">
                                                                                                <div class="col-xl-3">
                                                                                                    <label for="pincode-new1" class="form-label">Pincode</label>
                                                                                                    <input type="number" class="form-control" id="pincode-new1" placeholder="Pinicode" value="120000">
                                                                                                </div>
                                                                                                <div class="col-xl-3">
                                                                                                    <label for="city-new1" class="form-label">City</label>
                                                                                                    <input type="text" class="form-control" id="city-new1" placeholder="City" value="AnyTown">
                                                                                                </div>
                                                                                                <div class="col-xl-3">
                                                                                                    <label for="state-new1" class="form-label">State</label>
                                                                                                    <input type="text" class="form-control" id="state-new1" placeholder="State" value="New California, Texas">
                                                                                                </div>
                                                                                                <div class="col-xl-3">
                                                                                                    <label for="country-new1" class="form-label">Country</label>
                                                                                                    <input type="text" class="form-control" id="country-new1" placeholder="Country" value="USA">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                ...
                                                <div class="row gy-3 mt-3">
                                                    <div>
                                                        ...
                                                        <p class="text-muted fs-12 op-9 mb-1">Select one of the shipping methods below</p>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        <div class="form-check shipping-method-container mb-0">
                                                            ...
                                                            <div class="form-check-label ps-5">
                                                                <div class="d-sm-flex align-items-center justify-content-between">
                                                                    ...
                                                                    <div class="shipping-partner-details flex-fill me-sm-5 me-0">
                                                                        <p class="mb-0 fw-medium">UPS</p>
                                                                        <p class="text-muted fs-11 mb-0">Delivered before 24,Nov 2023</p>
                                                                    </div>
                                                                    <div class="fw-medium me-sm-3 me-0">
                                                                        $9.99
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-check-label ps-5">
                                                                <div class="d-sm-flex align-items-center justify-content-between">
                                                                    ...
                                                                    <div class="shipping-partner-details flex-fill me-sm-5 me-0">
                                                                        ...
                                                                        <p class="text-muted fs-11 mb-0">Delivered on or before 22,Nov 2023</p>
                                                                    </div>
                                                                    <div class="fw-medium me-sm-3 me-0">
                                                                        $10.49
                                                                    </div>
                                                            ...
                                                            <div class="form-check-label ps-5">
                                                                <div class="d-sm-flex align-items-center justify-content-between">
                                                                    ...
                                                                    <div class="shipping-partner-details flex-fill me-sm-5 me-0">
                                                                        ...
                                                                        <p class="text-muted fs-11 mb-0">Delivered Next Day</p>
                                                                    </div>
                                                                    <div class="fw-medium me-sm-3 me-0">
                                                                        $12.29
                                                                    </div>
                                            ...
                                            <div class="p-4">
                                                ...
                                                <div class="row gy-4">
                                                    ...
                                                    <div class="col-xl-6">
                                                        ...
                                                        <input type="text" class="form-control" id="lastname-personal" placeholder="Last Name" value="Anthony">
                                                    </div>
                                                    <div class="col-xl-6">
                                        ...
                                        <div class="tab-pane border-0 p-0" id="shipped-tab-pane" role="tabpanel"
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="Address" aria-label="address" aria-describedby="payment-address" value="34A/45-354, B-Block, PNN Street, Anytown,New California, Texas, USA,1200000">
                                                                <button type="button"  class="btn btn-info-light input-group-text" id="payment-address">Change</button>
                                                            </div>
                                                        </div>
                                                        <div class="card custom-card shadow-none mb-3">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row gy-3">
                                                                    ...
                                                                    <div class="col-xl-12">
                                                                        ...
                                                                        <input type="text" class="form-control" id="payment-card-name" placeholder="Name On Card" value="James Lucas">
                                                                    </div>
                                                                    <div class="col-xl-4">
                                                                ...
                                                                <div class="row gy-3">
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        <div class="form-check payment-card-container mb-0 lh-1">
                                                                            ...
                                                                            <div class="form-check-label ps-5">
                                                                                <div class="d-sm-flex d-block align-items-center justify-content-between gap-2">
                                                                                    <div class="saved-card-details">
                                                                                        <p class="mb-0 fw-medium">XXXX - XXXX - XXXX - 7557</p>
                                                                                    </div>
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        <div class="form-check payment-card-container mb-0 lh-1">
                                                                            ...
                                                                            <div class="form-check-label ps-5">
                                                                                <div class="d-sm-flex d-block align-items-center justify-content-between gap-2">
                                                                                    <div class="saved-card-details">
                                                                                        <p class="mb-0 fw-medium">XXXX - XXXX - XXXX - 5741</p>
                                                                                    </div>
                                                                                    <div class="ms-auto lh-1">
                                                                                        <span class="avatar avatar-md">
                                            ...
                                            <div class="px-4 py-3 border-top border-block-start-dashed d-sm-flex justify-content-between">
                                                ...
                                                <button type="button" class="btn btn-success-light m-1" id="continue-payment-trigger">Complete Order<i class="bi bi-credit-card-2-front align-middle ms-2 d-inline-block"></i></button>
                                            </div>
                                        </div>
                                        <div class="tab-pane border-0 p-0" id="delivery-tab-pane" role="tabpanel"
                                            ...
                                            <div class="p-5 checkout-payment-success my-3">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <h3 class="fw-semibold mb-2">Your Order is Confirmed</h3>
                                                    <p class="mb-1 fs-14">To track your order with Order ID <b>SPK#2AN</b>, please visit our <a class="link-success" href="javascript:void(0);"><u>Track Your Order</u></a> Page.</p>
                                                </div>
                            ...
                            <div class="card custom-card shadow-none">
                                ...
                                <div class="card-body p-0">
                                    <ul class="list-group mb-0 border-0 rounded-0">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap">
                                                <div class="me-2">
                                                    <span class="avatar avatar-lg bg-light">
                                                        <img src="{{asset('build/assets/images/ecommerce/jpg/13.jpg')}}" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li class="list-group-item  border-bottom border-block-end-dashed border-start-0 border-end-0">
                                            <div class="d-flex align-items-center flex-wrap">
                                                <div class="me-2">
                                                    <span class="avatar avatar-lg bg-light">
                                                        <img src="{{asset('build/assets/images/ecommerce/jpg/11.jpg')}}" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                    ...
                                    <div class="p-3 d-grid">
                                        <a href="{{url('cart')}}" class="btn btn-primary btn-wave">Edit Order</a>
                                    </div>
                                </div>
                            </div>
                        </div>
