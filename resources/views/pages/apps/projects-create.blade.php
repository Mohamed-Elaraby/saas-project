                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <select class="form-control" name="assigned-team-members" id="assigned-team-members" multiple>
                                            ...
                                            <option value="Choice 4" selected>Reva Shaan</option>
                                        </select>
                                    </div>
                                    <div class="col-xl-6">
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div id="project-descriptioin-editor">
                                            ...
                                            <p><br></p>
                                            <ol>
                                                <li class="ql-size-normal">Define the project's purpose, objectives,</li>
                                                <li class="">Create a detailed plan outlining tasks, milestones, timelines, and resource allocation.</li>
                                                <li class="">Break down project tasks into a detailed list, including dependencies and priorities.</li>
                                                <li class="">Define each team member's role and responsibilities to avoid confusion.</li>
                                                <li class="">Develop a plan for testing and quality assurance</li>
                                            </ol>
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
