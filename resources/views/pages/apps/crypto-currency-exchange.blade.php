                                                ...
                                                <div class="col-xxl-2 col-12">
                                                    <div>
                                                        <select class="form-control" data-trigger name="Vacancies">
                                                            ...
                                                            <option value="Choice 2">Ethereum</option> 
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-4">
                            <div class="card custom-card overflow-hidden">
                                ...
                                <div class="card-body mb-3">
                                    <div class="d-flex align-items-top justify-content-between mb-4 flex-wrap">
                                        <div>
                                            ...
                                            <span class="fs-22 d-flex align-items-center">24.3% <span class="fs-12 text-warning op-7 ms-2">+0.59<i class="ri-arrow-up-circle-line ms-1 d-inline-flex"></i></span><span class="badge bg-success-transparent fs-10 ms-2">24H</span></span>
                                        </div>
                                        <div class="text-end">
                                            <span class="d-block text-success fw-medium">$30.29</span>
                                            <span class="d-block fs-14 mb-1">0.00434</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex align-items-top justify-content-between mb-4 flex-wrap">
                                        <div>
                                            <div class="d-flex align-items-center gap-2 mb-1">
                                                ...
                                                <h6 class="fw-medium mb-0">Ethereum - ETH</h6>
                                            </div>
                                            <span class="fs-22 d-flex align-items-center">15.25% <span class="fs-12 text-warning op-7 ms-2">+1.30<i class="ri-arrow-up-circle-line ms-1 d-inline-flex"></i></span></span>
                                        </div>
                                        <div class="text-end">
                                            <span class="d-block text-success fw-medium">$2,283.73</span>
                                            <span class="d-block fs-14 mb-1">1.2923</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card overflow-hidden">
                                    ...
                                    <div class="d-flex align-items-top justify-content-between mb-4 flex-wrap">
                                        <div>
                                            <div class="d-flex align-items-center gap-2 mb-1">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-rounded avatar-xs">
                                                        <img src="{{asset('build/assets/images/crypto-currencies/square-color/Waves.svg')}}" alt="">
                                                    </span>
                                                </div>
                                                <h6 class="fw-medium mb-0">Waves</h6>
                                            </div>
                                            <span class="fs-22 d-flex align-items-center">15.25% <span class="fs-12 text-warning op-7 ms-2">+1.30<i class="ri-arrow-up-circle-line ms-1 d-inline-flex"></i></span></span>
                                        </div>
                                        <div class="text-end">
                                ...
                                <div id="waves-currency-chart" class="mt-1 w-100"></div>
                            </div>
                        </div>
                        <div class="col-xl-12">
