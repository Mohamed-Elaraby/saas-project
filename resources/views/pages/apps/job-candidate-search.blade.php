                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex flex-wrap gap-2 align-items-center">
                                                <h5 class="fw-medium mb-0 flex-grow-1">2134 <span class="fw-normal fs-18">Candidates match your job search</span> </h5>
                                                <div class="btn-group">
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="btn-list float-end">
                                                ...
                                                <a href="javascript:void(0);" class="avatar avatar-sm bg-light text-default border" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Add to Wishlist" title="Add to Wishlist"><span><i class="ri-heart-line fs-13 align-middle"></i></span></a>
                                                <a href="javascript:void(0);" class="avatar avatar-sm bg-light text-default border" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="View Profile" title="View Profile"><span><i class="ri-eye-line fs-13 align-middle"></i></span></a>
                                            </div>
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> Kingston <span class="fs-13 text-success"><i class="ri-checkbox-circle-line text-success fs-13 me-1 d-inline-block"></i>Verified</span></a></h5>
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        <a href="javascript:void(0);" class="fs-14">Software Developer</a>
                                                    ...
                                                    <div class="d-flex align-items-center fs-12 text-muted flex-wrap">
                                                        ...
                                                        <div class="min-w-fit-content ms-2">
                                                            ...
                                                            <span class="text-warning"><i class="ri-star-fill"></i></span>
                                                            <span class="text-warning"><i class="ri-star-fill"></i></span>
                                                            <span class="text-warning"><i class="ri-star-line-half"></i></span>
                                                        </div>
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-3 fs-14">
                                                <p class="mb-0 flex-grow-1"><span class="text-muted">Package (Yearly) :</span> <span class="fw-medium" data-bs-toggle="tooltip" title="Current"> $2,233</span> - <span class="fw-medium" data-bs-toggle="tooltip" title="Expected"> $5,145</span> </p>
                                        ...
                                        <div class="card-footer">
                                            <div class="d-flex align-items-center gap-3 flex-wrap">
                                                ...
                                                <div class="popular-tags flex-grow-1">
                                                    ...
                                                    <a href="javascript:void(0);" class="badge bg-primary-transparent">More</a>
                                                </div>
                                                <div>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> Juliana <span class="fs-13 text-success"><i class="ri-checkbox-circle-line text-success fs-13 me-1 d-inline-block"></i>Verified</span></a></h5>
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        <a href="javascript:void(0);" class="fs-14">Web Developer</a>
                                                        <p class="mb-0 fs-12 text-muted"><i class="bi bi-geo-alt fs-11"></i> Coimbatore, Chennai</p>
                                                    </div> 
                                                    <div class="d-flex align-items-center fs-12 text-muted flex-wrap">
                                                        <p class="fs-12 mb-0">Ratings : </p>
                                                        <div class="min-w-fit-content ms-2">
                                                            ...
                                                            <span class="text-warning"><i class="ri-star-fill"></i></span>
                                                            <span class="text-warning"><i class="ri-star-fill"></i></span>
                                                            <span class="text-warning"><i class="ri-star-line"></i></span>
                                                            <span class="text-warning"><i class="ri-star-line"></i></span>
                                                        </div>
                                            ...
                                            <div class="popular-tags mb-2">
                                                <a href="javascript:void(0);" class="fs-13 me-2"><i class="bi bi-mortarboard text-primary me-1"></i> Post Graduate</a>
                                                <span class="vr align-middle me-2"></span>
                                                <a href="javascript:void(0);" class="fs-13 me-2"><i class="bi bi-moon-stars text-primary me-1"></i> flexible-shift</a>
                                                <span class="vr align-middle me-2"></span>
                                                <a href="javascript:void(0);" class="fs-13 me-2"><i class="bi bi-clock text-primary me-1"></i> Within 15 Days</a>
                                                <span class="vr align-middle me-2"></span>
                                                <a href="javascript:void(0);" class="fs-13 me-2"><i class="bi bi-broadcast text-primary me-1"></i> Good at English</a>
                                            </div>
                                            <div class="d-flex align-items-center flex-wrap gap-3 fs-14">
                                                <p class="mb-0 flex-grow-1"><span class="text-muted">Package (Yearly) :</span> <span class="fw-medium" data-bs-toggle="tooltip" title="Current"> $2,800</span> - <span class="fw-medium" data-bs-toggle="tooltip" title="Expected"> $5,650</span> </p>
                                        ...
                                        <div class="card-footer">
                                            <div class="d-flex align-items-center gap-3 flex-wrap">
                                                ...
                                                <div class="popular-tags flex-grow-1">
                                                    ...
                                                    <a href="javascript:void(0);" class="badge bg-light text-default">React Native</a>
                                                    <a href="javascript:void(0);" class="badge bg-primary-transparent">More</a>
                                                </div>
                                                <div>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> Deborah <span class="fs-13 text-success"><i class="ri-checkbox-circle-line text-success fs-13 me-1 d-inline-block"></i>Verified</span></a></h5>
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        <a href="javascript:void(0);" class="fs-14">Python Developer</a>
                                                        <p class="mb-0 fs-12 text-muted"><i class="bi bi-geo-alt fs-11"></i> Gachibowli, UAE</p>
                                                    </div> 
                                                    <div class="d-flex align-items-center fs-12 text-muted flex-wrap">
                                                        <p class="fs-12 mb-0">Ratings : </p>
                                                        <div class="min-w-fit-content ms-2">
                                            ...
                                            <div class="popular-tags mb-2">
                                                <a href="javascript:void(0);" class="fs-13 me-2"><i class="bi bi-mortarboard text-primary me-1"></i> MBA</a>
                                                <span class="vr align-middle me-2"></span>
                                                <a href="javascript:void(0);" class="fs-13 me-2"><i class="bi bi-moon-stars text-primary me-1"></i> Day-shift</a>
                                                <span class="vr align-middle me-2"></span>
                                                <a href="javascript:void(0);" class="fs-13 me-2"><i class="bi bi-clock text-primary me-1"></i> Within 20 Days</a>
                                                <span class="vr align-middle me-2"></span>
                                                <a href="javascript:void(0);" class="fs-13 me-2"><i class="bi bi-broadcast text-primary me-1"></i> Avg at English</a>
                                            </div>
                                            <div class="d-flex align-items-center flex-wrap gap-3 fs-14">
                                                <p class="mb-0 flex-grow-1"><span class="text-muted">Package (Yearly) :</span> <span class="fw-medium" data-bs-toggle="tooltip" title="Current"> $4,260</span> - <span class="fw-medium" data-bs-toggle="tooltip" title="Expected"> $5,600</span> </p>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> James Lucas <span class="fs-13 text-success"><i class="ri-checkbox-circle-line text-success fs-13 me-1 d-inline-block"></i>Verified</span></a></h5>
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        <a href="javascript:void(0);" class="fs-14">Angular Developer</a>
                                            ...
                                            <div class="popular-tags mb-2">
                                                <a href="javascript:void(0);" class="fs-13 me-2"><i class="bi bi-mortarboard text-primary me-1"></i> MCA</a>
                                                <span class="vr align-middle me-2"></span>
                                                <a href="javascript:void(0);" class="fs-13 me-2"><i class="bi bi-moon-stars text-primary me-1"></i> flexible-shift</a>
                                                <span class="vr align-middle me-2"></span>
                                                <a href="javascript:void(0);" class="fs-13 me-2"><i class="bi bi-clock text-primary me-1"></i> Within 15 Days</a>
                                                <span class="vr align-middle me-2"></span>
                                                <a href="javascript:void(0);" class="fs-13 me-2"><i class="bi bi-broadcast text-primary me-1"></i> Fluent at English</a>
                                            </div>
                                            <div class="d-flex align-items-center flex-wrap gap-3 fs-14">
                                                <p class="mb-0 flex-grow-1"><span class="text-muted">Package (Yearly) :</span> <span class="fw-medium" data-bs-toggle="tooltip" title="Current"> $2,800</span> - <span class="fw-medium" data-bs-toggle="tooltip" title="Expected"> $5,650</span> </p>
                                                <p class="mb-0"><span class="text-muted"> Languages :</span> <span class="fw-medium"> English, Telugu</span></p>
                                        ...
                                        <div class="card-footer">
                                            <div class="d-flex align-items-center gap-3 flex-wrap">
                                                ...
                                                <div class="popular-tags flex-grow-1">
                                                    ...
                                                    <a href="javascript:void(0);" class="badge bg-light text-default">Advanced Java</a>
                                                    <a href="javascript:void(0);" class="badge bg-primary-transparent">More</a>
                                                </div>
                                                <div>
                                                    <a href="javascript:void(0);" class="badge badge-md bg-info-transparent" data-bs-toggle="tooltip" title="1 year bond accepted"><i class="bi bi-hand-thumbs-up me-1"></i>2 years bond accepted</a>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> Robin Keith <span class="fs-13 text-success"><i class="ri-checkbox-circle-line text-success fs-13 me-1 d-inline-block"></i>Verified</span></a></h5>
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        <a href="javascript:void(0);" class="fs-14">AWS Developer</a>
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-3 fs-14">
                                                <p class="mb-0 flex-grow-1"><span class="text-muted">Package (Yearly) :</span><span class="fw-medium" data-bs-toggle="tooltip" title="Expected"> $9,120</span> </p>
                                                <p class="mb-0"><span class="text-muted"> Languages :</span> <span class="fw-medium"> English, Hindi, Telugu</span></p>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <div class="d-flex align-items-center gap-3 flex-wrap">
                                                <h6 class="mb-0 fw-medium">Skills :</h6>
                                                <div class="popular-tags flex-grow-1">
                                                    <a href="javascript:void(0);" class="badge bg-light text-default">AWS Lambda</a>
                                                    <a href="javascript:void(0);" class="badge bg-light text-default">Athena</a>
                                                    <a href="javascript:void(0);" class="badge bg-light text-default">Linux</a>
                                                    <a href="javascript:void(0);" class="badge bg-primary-transparent">More</a>
                                                </div>
                                                <div>
                                                    <a href="javascript:void(0);" class="badge badge-md bg-primary-transparent"><i class="bi bi-briefcase me-1"></i>Fresher</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> Katrina <span class="fs-13 text-success"><i class="ri-checkbox-circle-line text-success fs-13 me-1 d-inline-block"></i>Verified</span></a></h5>
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        <a href="javascript:void(0);" class="fs-14">Software Developer</a>
                                                        <p class="mb-0 fs-12 text-muted"><i class="bi bi-geo-alt fs-11"></i> Saidapet, Chennai</p>
                                                    </div> 
                                            ...
                                            <div class="popular-tags mb-2">
                                                <a href="javascript:void(0);" class="fs-13 me-2"><i class="bi bi-mortarboard text-primary me-1"></i> Graduate</a>
                                                <span class="vr align-middle me-2"></span>
                                                <a href="javascript:void(0);" class="fs-13 me-2"><i class="bi bi-moon-stars text-primary me-1"></i> flexible-shift</a>
                                                <span class="vr align-middle me-2"></span>
                                                <a href="javascript:void(0);" class="fs-13 me-2"><i class="bi bi-clock text-primary me-1"></i> Immediate Joinee</a>
                                                <span class="vr align-middle me-2"></span>
                                                <a href="javascript:void(0);" class="fs-13 me-2"><i class="bi bi-broadcast text-primary me-1"></i> Good at English</a>
                                            </div>
                                            <div class="d-flex align-items-center flex-wrap gap-3 fs-14">
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> Isabella <span class="fs-13 text-success"><i class="ri-checkbox-circle-line text-success fs-13 me-1 d-inline-block"></i>Verified</span></a></h5>
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        <a href="javascript:void(0);" class="fs-14">Web Developer</a>
                                                        <p class="mb-0 fs-12 text-muted"><i class="bi bi-geo-alt fs-11"></i> Coimbatore, Chennai</p>
                                                    </div> 
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> Alexia <span class="fs-13 text-success"><i class="ri-checkbox-circle-line text-success fs-13 me-1 d-inline-block"></i>Verified</span></a></h5>
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        <a href="javascript:void(0);" class="fs-14">Python Developer</a>
                                                        <p class="mb-0 fs-12 text-muted"><i class="bi bi-geo-alt fs-11"></i> Gachibowli, UAE</p>
                                                    </div> 
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="{{url('job-candidate-details')}}">Amelia <span class="fs-13 text-success"><i class="ri-checkbox-circle-line text-success fs-13 me-1 d-inline-block"></i>Verified</span></a></h5>
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        <a href="javascript:void(0);" class="fs-14">Java Developer</a>
                                                        <p class="mb-0 fs-12 text-muted"><i class="bi bi-geo-alt fs-11"></i> Sydney, Australia</p>
                                                    </div> 
                                                    <div class="d-flex align-items-center fs-12 text-muted flex-wrap">
                                                        <p class="fs-12 mb-0">Ratings : </p>
                                                        <div class="min-w-fit-content ms-2">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-3 fs-14">
                                                <p class="mb-0 flex-grow-1"><span class="text-muted">Package (Yearly) :</span><span class="fw-medium" data-bs-toggle="tooltip" title="Expected"> $5,145</span> </p>
                                                <p class="mb-0"><span class="text-muted"> Languages :</span> <span class="fw-medium"> English, Hindi, Telugu</span></p>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <div class="d-flex align-items-center gap-3 flex-wrap">
                                                ...
                                                <div class="popular-tags flex-grow-1">
                                                    <a href="javascript:void(0);" class="badge bg-light text-default">Java</a>
                                                    <a href="javascript:void(0);" class="badge bg-light text-default">Core Java</a>
                                                    <a href="javascript:void(0);" class="badge bg-primary-transparent">More</a>
                                                </div>
                                                <div>
                                                    <a href="javascript:void(0);" class="badge badge-md bg-info-transparent" data-bs-toggle="tooltip" title="1 year bond accepted"><i class="bi bi-hand-thumbs-up me-1"></i>2 years bond accepted</a>
                        ...
                        <div class="col-xxl-3">
                            <div class="card custom-card products-navigation-card">
                                ...
                                <div class="card-header justify-content-between">
                                    ...
                                    <a href="javascript:void(0);" class="text-info fw-medium badge bg-info-transparent">
                                        Reset All
                                    </a>
                                </div>
                                    ...
                                    <div class="px-2 py-4 px-sm-4 border-bottom">
                                        ...
                                        <div class="px-2 py-3 pb-0">
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-light text-default fw-500 float-end">3,417</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-light text-default fw-500 float-end">345</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-light text-default fw-500 float-end">15,427</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-light text-default fw-500 float-end">2,457</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-light text-default fw-500 float-end">1,542</span>
                                            </div>
                                            <div class="collapse" id="category-more">
                                                <div class="form-check mb-2">
                                                    ...
                                                    <span class="badge bg-light text-default fw-500 float-end">8,466</span>
                                                </div>
                                                <div class="form-check mb-2">
                                                    ...
                                                    <span class="badge bg-light text-default fw-500 float-end">6,100</span>
                                                </div>
                                            </div>
