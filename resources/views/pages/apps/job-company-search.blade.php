                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <h5 class="fw-medium mb-0 flex-grow-1">2134 <span class="fw-normal fs-18">Companies match for your search</span> </h5>
                                                <div class="btn-group">
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="btn-list float-end">
                                                <a href="javascript:void(0);" class="avatar bg-danger-transparent text-default avatar-sm" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Add to Wishlist" title="Add to Wishlist"><span><i class="ri-heart-line align-middle fs-14 text-danger"></i></span></a>
                                                <a href="javascript:void(0);" class="avatar bg-info-transparent text-default avatar-sm" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Share" title="Share"><span><i class="ri-share-line align-middle fs-14 text-info"></i></span></a>
                                            </div>
                                            <div class="d-flex align-items-start flex-wrap gap-2">
                                                <span class="avatar avatar-xl bg-white shadow-sm border p-1 avatar-rounded">
                                                    <img src="{{asset('build/assets/images/company-logos/1.png')}}" alt="">
                                                </span>
                                                <div class="ms-2">
                                                    <h5 class="fw-medium mb-1 d-flex align-items-center"><a href="javascript:void(0);"> Innovatepix Co.in <span class="fs-13 text-success"><i class="ri-checkbox-circle-line text-success fs-13 me-1 d-inline-block"></i>Verified</span></a></h5>
                                                    <div class="d-flex gap-2">
                                                        <a href="javascript:void(0);"><i class="bi bi-geo-alt fs-11"></i> Paris, France </a>
                                                        <p class="mb-0 text-muted">Establishment year - 1996</p>
                                                        <span class="fs-13 fw-medium ms-2"><i class="ri-subtract-fill text-success me-1 d-inline-block fs-7 align-middle"></i>Posted 3 Days ago</span>
                                                    </div> 
                                        ...
                                        <div class="card-footer">
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <div class="flex-grow-1">
                                                    <a href="javascript:void(0);" class="badge badge-md rounded-pill bg-info-transparent" data-bs-toggle="tooltip" title="No of employees"><i class="bi bi-people me-1"></i>No. of Emp : 241</a>
                                                    <a href="javascript:void(0);" class="badge badge-md rounded-pill bg-primary-transparent"><i class="bi bi-briefcase me-1"></i>Vacancies : 13</a>
                                                </div>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-start flex-wrap gap-2">
                                                ...
                                                <div class="ms-2">
                                                    <h5 class="fw-medium mb-1 d-flex align-items-center"><a href="javascript:void(0);"> FutureBud Solutions <span class="fs-13 text-success"><i class="ri-checkbox-circle-line text-success fs-13 me-1 d-inline-block"></i>Verified</span></a></h5>
                                                    <div class="d-flex gap-2 fs-14">
                                                        <a href="javascript:void(0);"><i class="bi bi-geo-alt fs-11"></i> Dubai, UAE </a>
                                                        <p class="mb-0 text-muted">Establishment year - 2001</p>
                                                        <span class="fs-13 fw-medium ms-2"><i class="ri-subtract-fill text-success me-1 d-inline-block fs-7 align-middle"></i>Posted 3 Days ago</span>
                                                    </div> 
                                                    <div class="d-flex align-items-center fs-12 text-muted">
                                                        <p class="fs-12 mb-0">Ratings : </p>
                                        ...
                                        <div class="card-footer">
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <div class="flex-grow-1">
                                                    <a href="javascript:void(0);" class="badge badge-md rounded-pill bg-info-transparent" data-bs-toggle="tooltip" title="No of employees"><i class="bi bi-people me-1"></i>No. of Emp : 182</a>
                                                    <a href="javascript:void(0);" class="badge badge-md rounded-pill bg-primary-transparent"><i class="bi bi-briefcase me-1"></i>Vacancies : 42</a>
                                                </div>
                                                <a href="javascript:void(0);" class="btn btn-wave btn-primary">
                                                    View Profile <i class="ri-arrow-right-line align-middle"></i>
                                                </a>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-start flex-wrap gap-2">
                                                ...
                                                <div class="ms-2">
                                                    <h5 class="fw-medium mb-1 d-flex align-items-center"><a href="javascript:void(0);"> TechicGen PVT LTD <span class="fs-13 text-success"><i class="ri-checkbox-circle-line text-success fs-13 me-1 d-inline-block"></i>Verified</span></a></h5>
                                                    <div class="d-flex gap-2 fs-14">
                                                        <a href="javascript:void(0);"><i class="bi bi-geo-alt fs-11"></i> London, UK, </a>
                                        ...
                                        <div class="card-footer">
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <div class="flex-grow-1">
                                                    <a href="javascript:void(0);" class="badge badge-md rounded-pill bg-info-transparent" data-bs-toggle="tooltip" title="No of employees"><i class="bi bi-people me-1"></i>No. of Emp : 32</a>
                                                    <a href="javascript:void(0);" class="badge badge-md rounded-pill bg-primary-transparent"><i class="bi bi-briefcase me-1"></i>Vacancies : 13</a>
                                                </div>
                                                <a href="javascript:void(0);" class="btn btn-wave btn-primary">
                                                    View Profile <i class="ri-arrow-right-line align-middle"></i>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-start flex-wrap gap-2">
                                                ...
                                                <div class="ms-2">
                                                    <h5 class="fw-medium mb-1 d-flex align-items-center"><a href="javascript:void(0);"> Pinnacle Apex Solutions <span class="fs-13 text-success"><i class="ri-checkbox-circle-line text-success fs-13 me-1 d-inline-block"></i>Verified</span></a></h5>
                                                    <div class="d-flex gap-2 fs-14">
                                                        <a href="javascript:void(0);"><i class="bi bi-geo-alt fs-11"></i> Sydney, Australia, </a>
                                                        <p class="mb-0 text-muted">Establishment year - 2005</p>
                                                        <span class="fs-13 fw-medium ms-2"><i class="ri-subtract-fill text-success me-1 d-inline-block fs-7 align-middle"></i>Posted 2 Days ago</span>
                                                    </div> 
                                                    <div class="d-flex align-items-center fs-12 text-muted">
                                                        <p class="fs-12 mb-0">Ratings : </p>
                                                        <div class="min-w-fit-content ms-2">
                                        ...
                                        <div class="card-footer">
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <div class="flex-grow-1">
                                                    <a href="javascript:void(0);" class="badge badge-md rounded-pill bg-info-transparent" data-bs-toggle="tooltip" title="No of employees"><i class="bi bi-people me-1"></i>No. of Emp : 127</a>
                                                    <a href="javascript:void(0);" class="badge badge-md rounded-pill bg-primary-transparent"><i class="bi bi-briefcase me-1"></i>Vacancies : 22</a>
                                                </div>
                                                <a href="javascript:void(0);" class="btn btn-wave btn-primary">
                                                    View Profile <i class="ri-arrow-right-line align-middle"></i>
                                                </a>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-start flex-wrap gap-2">
                                                ...
                                                <div class="ms-2">
                                                    <h5 class="fw-medium mb-1 d-flex align-items-center"><a href="javascript:void(0);"> Renith Innovations Corp. <span class="fs-13 text-success"><i class="ri-checkbox-circle-line text-success fs-13 me-1 d-inline-block"></i>Verified</span></a></h5>
                                                    <div class="d-flex gap-2 fs-14">
                                                        <a href="javascript:void(0);"><i class="bi bi-geo-alt fs-11"></i> Sydney, Australia, </a>
                                                        <p class="mb-0 text-muted">Establishment year - 2020</p>
                                                        <span class="fs-13 fw-medium ms-2"><i class="ri-subtract-fill text-success me-1 d-inline-block fs-7 align-middle"></i>Posted 2 Days ago</span>
                                                    </div> 
                                                    <div class="d-flex align-items-center fs-12 text-muted">
                                                        <p class="fs-12 mb-0">Ratings : </p>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-start flex-wrap gap-2">
                                                ...
                                                <div class="ms-2">
                                                    <h5 class="fw-medium mb-1 d-flex align-items-center"><a href="javascript:void(0);"> Vista Nexus Technologies <span class="fs-13 text-success"><i class="ri-checkbox-circle-line text-success fs-13 me-1 d-inline-block"></i>Verified</span></a></h5>
                                                    <div class="d-flex gap-2 fs-14">
                                                        <a href="javascript:void(0);"><i class="bi bi-geo-alt fs-11"></i> Tokyo, Japan </a>
                                                        <p class="mb-0 text-muted">Establishment year - 2000</p>
                                                        <span class="fs-13 fw-medium ms-2"><i class="ri-subtract-fill text-success me-1 d-inline-block fs-7 align-middle"></i>Posted 1 Day ago</span>
                                                    </div> 
                                                    <div class="d-flex align-items-center fs-12 text-muted">
                                                        <p class="fs-12 mb-0">Ratings : </p>
                                                        <div class="min-w-fit-content ms-2">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-start flex-wrap gap-2">
                                                ...
                                                <div class="ms-2">
                                                    <h5 class="fw-medium mb-1 d-flex align-items-center"><a href="javascript:void(0);"> FutureBud Solutions <span class="fs-13 text-success"><i class="ri-checkbox-circle-line text-success fs-13 me-1 d-inline-block"></i>Verified</span></a></h5>
                                                    <div class="d-flex gap-2 fs-14">
                                                        <a href="javascript:void(0);"><i class="bi bi-geo-alt fs-11"></i> Mumbai, India, </a>
                                                        <p class="mb-0 text-muted">Establishment year - 2001</p>
                                                        <span class="fs-13 fw-medium ms-3"><i class="ri-subtract-fill text-success me-1 d-inline-block fs-7 align-middle"></i>Posted 4hrs ago</span>
                                                    </div> 
                                                    <div class="d-flex align-items-center fs-12 text-muted">
                                                        <p class="fs-12 mb-0">Ratings : </p>
                                                        <div class="min-w-fit-content ms-2">
                                    ...
                                    <div class="p-4 border-bottom">
                                        ...
                                        <div class="px-2 py-3 pb-0">
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-light text-default  float-end">3,417</span>
                                            </div>
                                            <div class="form-check mb-2">
