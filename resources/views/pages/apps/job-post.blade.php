                                ...
                                <div class="card-body">
                                    <div class="col-xl-12">
                                        ...
                                        <select class="form-control" data-trigger name="Category-select">
                                            <option value="Choice 1">Quantum Innovations Inc.</option>
                                            <option value="Choice 2">Horizon Enterprises</option>
                                            <option value="Choice 3">SwiftSynergy.pvt.ltd</option>
                                            <option value="Choice 4">Innovatepix Co.in</option>
                                        </select>
                                    </div>                                 
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row gy-3">
                                        <div class="col-xl-12">
                                            ...
                                            <input type="text" class="form-control" id="Company-Name" placeholder="Company Name" value="Quantum Innovations Inc">
                                        </div>                                 
                                        <div class="col-xl-12">
                                            <label for="Company-Website" class="form-label">Company Website</label> 
                                            <input type="text" class="form-control" id="Company-Website" placeholder="Company Website" value="http//www.quantuminnovations.com">
                                        </div>  
                                        <div class="col-xl-12"> 
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <input type="text" class="form-control" id="Company-email" placeholder="Company Email Address" value="quantuminnovations1@mail.com">
                                        </div>   
                                        <div class="col-xl-12">
                                            <label for="Company-Phone-Number" class="form-label">Phone Number</label> 
                                            <input type="text" class="form-control" id="Company-Phone-Number" placeholder="Company Phone Number" value="+121-1400-559858">
                                        </div>   
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row gy-4 mb-4"> 
                                        <div class="col-xl-6">
                                            ...
                                            <input type="text" class="form-control" id="job-title" placeholder="Job Title" value="React Developer">
                                        </div>
                                        <div class="col-xl-6">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <select class="form-control" data-trigger name="Experience">
                                                <option value="Choice 1">0 - 2 Years</option>
                                        ...
                                        <div class="col-xl-6"> 
                                            ...
                                            <select class="form-control" data-trigger name="Vacancies">
                                                <option value="Choice 2">12</option> 
                                        ...
                                        <div class="col-xl-6"> 
                                            ...
                                            <select class="form-control" data-trigger name="Salary">
                                                <option value="Choice 2">0 - $1,50,000 / Year</option> 
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <select class="form-control" data-trigger name="JobLocation" id="JobLocation">
                                                <option value="Choice 1">Hyderabad</option>
                                                <option value="Choice 2">Chennai</option>
                                                <option value="Choice 3">Bangalore</option>
                                                <option value="Choice 4">Vizag</option>
                                            </select>
                                        </div> 
                                        <div class="col-xl-12">
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <textarea class="form-control" id="job-description" rows="4">Lorem In dapibus molestie odio eget tincidunt.Suada dignissim, egestas vel mi. Vestibulum vitae turpis ex. Nunc dictum et tortor et dapibus.</textarea>
                                        </div>
                                    </div>
                                </div>
