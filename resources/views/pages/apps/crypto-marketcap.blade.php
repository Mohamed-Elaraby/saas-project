...
@section('content')
            ...
            <div class="main-content app-content">
                <div class="container-fluid">
                    ...
                    <!-- Start::row-1 -->
                    <div class="row">
                        <div class="col-xxl-4 col-xxl-4 col-lg-12">
                            <div class="card custom-card overflow-hidden">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end">
                                        <div>
                                            <p class="mb-1 fs-13">BTC / USD</p>
                                            <p class="fs-18 mb-0 fw-medium lh-1 text-primary">$25,886.16</p>
                                        </div>
                                        <div class="ms-auto text-end">
                                            <p class="mb-0">$0.02</p>
                                            <p class="fs-14 mb-0 text-muted"><span class="text-muted">Vol:</span>(+2.11%)</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="list-group border-0">
                                        <a href="javascript:void(0);" class="list-group-item flex-column align-items-start border-0 p-0 pb-1">
                                            <div class="d-flex w-100 justify-content-between align-items-center">
                                                <p class="fs-13 mb-0 font-weight-semibold text-dark">Price Change <span class="badge bg-primary-transparent ms-3 text-primary">Increased</span></p>
                                                <p class="text-success mb-0 font-weight-normal fs-13">
                                                    <span class="numberfont">+380.30(0.26%)</span> <i class="fa fa-arrow-up"></i> today
                                                </p>
                                            </div>
                                        </a>
                                        <a href="javascript:void(0);" class="list-group-item flex-column align-items-start border-0 p-0">
                                            <div class="d-flex w-100 justify-content-between align-items-center">
                                                <p class="fs-13 mb-0 font-weight-semibold text-dark">Market Rank<span class="badge bg-secondary-transparent ms-3">3 Years</span></p>
                                                <p class="text-dark mb-0 tx-15">
                                                    <span class="numberfont text-warning">#6</span>
                                                </p>
                                            </div>
                                        </a>
                                    </div>
                        ...
                        <div class="col-xxl-4 col-xxl-4 col-lg-12">
                            <div class="card custom-card overflow-hidden">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end">
                                        <div>
                                            <p class="mb-1 fs-13">ETH / USD</p>
                                            <p class="fs-18 mb-0 fw-medium lh-1 text-primary">$45,246.17</p>
                                        </div>
                                        <div class="ms-auto text-end">
                                            <p class="mb-0">$2.03</p>
                                            <p class="fs-14 mb-0 text-muted"><span class="text-muted">Vol:</span>(+10.45%)</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="list-group border-0">
                                        <a href="javascript:void(0);" class="list-group-item flex-column align-items-start border-0 p-0 pb-1">
                                            <div class="d-flex w-100 justify-content-between align-items-center">
                                                <p class="fs-13 mb-0 font-weight-semibold text-dark">Price Change <span class="badge bg-primary-transparent ms-3 text-primary">Increased</span></p>
                                                <p class="text-success mb-0 font-weight-normal fs-13">
                                                    <span class="numberfont">+1,044.24(2.42%)</span> <i class="fa fa-arrow-up"></i> today
                                                </p>
                                            </div>
                                        </a>
                                        <a href="javascript:void(0);" class="list-group-item flex-column align-items-start border-0 p-0">
                                            <div class="d-flex w-100 justify-content-between align-items-center">
                                                <p class="fs-13 mb-0 font-weight-semibold text-dark">Market Rank</p>
                                                <p class="text-dark mb-0 tx-15">
                                                    <span class="numberfont text-warning">#5</span>
                                                </p>
                                            </div>
                                        </a>
                                    </div>
                        ...
                        <div class="col-xxl-4 col-xxl-4 col-lg-12">
                            <div class="card custom-card overflow-hidden">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end">
                                        <div>
                                            <p class="mb-1 fs-13">DASH / USD</p>
                                            <p class="fs-18 mb-0 fw-medium lh-1 text-primary">$33,341.000</p>
                                        </div>
                                        <div class="ms-auto text-end">
                                            <p class="mb-0">$15.32</p>
                                            <p class="fs-14 mb-0 text-muted"><span class="text-muted">Vol:</span>(+124.40%)</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="list-group border-0">
                                        <a href="javascript:void(0);" class="list-group-item flex-column align-items-start border-0 p-0 pb-1">
                                            <div class="d-flex w-100 justify-content-between align-items-center">
                                                <p class="fs-13 mb-0 font-weight-semibold text-dark">Price Change <span class="badge bg-primary-transparent ms-3 text-primary">Increased</span></p>
                                                <p class="text-success mb-0 font-weight-normal fs-13">
                                                    <span class="numberfont">+21.17 (1.02%)</span> <i class="fa fa-arrow-up"></i> today
                                                </p>
                                            </div>
                                        </a>
                                        <a href="javascript:void(0);" class="list-group-item flex-column align-items-start border-0 p-0">
                                            <div class="d-flex w-100 justify-content-between align-items-center">
                                                <p class="fs-13 mb-0 font-weight-semibold text-dark">Market Rank</p>
                                                <p class="text-dark mb-0 tx-15">
                                                    <span class="numberfont text-warning">#45</span>
                                                </p>
                                            </div>
                                        </a>
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="fw-medium">
                                                            <a href="javascript:void(0);">$30,948.80</a>
                                                        </span>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div class="fw-medium"><a href="javascript:void(0);">Ethereum (ETH)</a></div>
                                                        </div>
                                                    </td>
                                                    <td>
                            ...
                            <div class="card custom-card overflow-hidden">
                                        ...
                                        <li class="list-group-item">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <span class="d-block fw-medium fs-13">Bitcoin</span>
                                                        <span class="d-block text-muted fs-12 fw-normal">$30,948.80</span>
                                                    </div>
                                                </div>
                                                <div>
                                                    <span class="fs-12 text-muted">Max Limit</span>
                                                    <span class="fw-medium d-block fs-13">50 BTC</span>
                                                </div>
                                                <div>
                                                    <span class="fs-12 text-muted">My Volume</span>
                                                    <span class="fw-medium d-block fs-13">42.2450 BTC</span>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="list-group-item">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <span class="d-block fw-medium fs-13">Litecon</span>
                                                        <span class="d-block text-muted fs-12 fw-normal">$5232.98</span>
                                                    </div>
                                                </div>
                                                <div>
                                                    <span class="fs-12 text-muted">Max Limit</span>
                                                    <span class="fw-medium d-block fs-13">200 LTC</span>
                                                </div>
                                                <div class="text-end">
                                                    <span class="fs-12 text-muted">My Volume</span>
                                                    <span class="fw-medium d-block fs-13">31.0023 LTC</span>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="list-group-item">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <span class="d-block fw-medium fs-13">Ethereum</span>
                                                        <span class="d-block text-muted fs-12 fw-normal">$1,895.96</span>
                                                    </div>
                                                </div>
                                                <div>
                                                    <span class="fs-12 text-muted">Max Limit</span>
                                                    <span class="fw-medium d-block fs-13">100 ETH</span>
                                                </div>
                                                <div>
                                                    <span class="fs-12 text-muted">My Volume</span>
                                                    <span class="fw-medium d-block fs-13">19.2412 BTC</span>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="list-group-item">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <span class="d-block fw-medium fs-13">Dash</span>
                                                        <span class="d-block text-muted fs-12 fw-normal">$1,895.96</span>
                                                    </div>
                                                </div>
                                                <div>
                                                    <span class="fs-12 text-muted">Max Limit</span>
                                                    <span class="fw-medium d-block fs-13">98 DASH</span>
                                                </div>
                                                <div>
                                                    <span class="fs-12 text-muted">My Volume</span>
                                                    <span class="fw-medium d-block fs-13">56.1457 DASH</span>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                                ...
                                <div class="card-footer">
                                    <div class="text-center">
                                        <a href="javascript:void(0);" class="fw-medium text-success fs-13 text-decoration-underline">View All Currencies</a>
                                    </div>
                                </div>
                            </div>
                        </div>
