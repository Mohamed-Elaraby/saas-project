                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-header justify-content-between pb-3">
                                    <div class="card-title">
                                        Companies <span class="badge bg-light text-default rounded ms-1 fs-12 align-middle">27</span>
                                    </div>
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-sm p-1 bg-primary-transparent avatar-rounded">
                                                                    <img src="{{asset('build/assets/images/company-logos/1.png')}}" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                                <a  data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample">Nexis Technologies</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted d-inline-block"></i>texistechnologies471@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted d-inline-block"></i>4777-54755-771</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <span class="d-block fw-medium">Kingston</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a  data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample">MarbelsIntech solution</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted d-inline-block"></i>marbelsintechsolution9@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted d-inline-block"></i>8741-8547-5661</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center flex-wrap gap-1">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <span class="d-block fw-medium">Noel</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a  data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample">Classic Marketing</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted d-inline-block"></i>classicmarketing01@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted d-inline-block"></i>9874-7742-3220</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center flex-wrap gap-1">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <span class="d-block fw-medium">Sandy</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a  data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample">Indusakis Services</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted d-inline-block"></i>indusakisservices74@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted d-inline-block"></i>1200-2520-5884</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center flex-wrap gap-1">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <span class="d-block fw-medium">Juliana</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a  data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample">Internatinal Indus</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted d-inline-block"></i>internatinalindus04@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <span class="d-block fw-medium">Silvia</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a  data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample">Convention Prime</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted d-inline-block"></i>conventionprime47@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted d-inline-block"></i>8821-5785-5742</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center flex-wrap gap-1">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <span class="d-block fw-medium">James Lucas</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a  data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample">Pride Corporation</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted d-inline-block"></i>pridecorporation66@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted d-inline-block"></i>3582-8151-8452</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center flex-wrap gap-1">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <span class="d-block fw-medium">Stuart</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a  data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample">Manish's Manufactures</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted d-inline-block"></i>manishsmanufactures44@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted d-inline-block"></i>4711-1242-0021</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center flex-wrap gap-1">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <span class="d-block fw-medium">Alexia</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a  data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample">Travels Services</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted d-inline-block"></i>travelsservices641@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted d-inline-block"></i>8451-5484-8885</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center flex-wrap gap-1">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <span class="d-block fw-medium">Julinia</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a  data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample">HyraKen Technologies</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted d-inline-block"></i>hyrakentechnologies474@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted d-inline-block"></i>8744-5811-5874</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center flex-wrap gap-1">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <span class="d-block fw-medium">George</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample"
                        aria-labelledby="offcanvasExample">
                            <div class="offcanvas-body p-0">
                                <div class="d-sm-flex align-items-top p-4 main-profile-cover bg-primary">
                                    <div>
                                        <span class="avatar avatar-xl avatar-rounded me-3 bg-light-transparent p-2 border">
                                            <img src="{{asset('build/assets/images/company-logos/1.png')}}" alt="">
                                        </span>
                                    </div>
                                    <div class="flex-fill main-profile-info">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h6 class="fw-bold mb-1 text-fixed-white">Nexis Technologies</h6>
                                        ...
                                        <p class="fs-12 text-fixed-white mb-4 op-6">  
                                        ...
                                        <div class="d-flex mb-0">
                                            <div class="me-4">
                                                ...
                                                <p class="mb-0 fs-11 op-6 text-fixed-white">Deals</p>
                                            </div>
                                            <div class="me-4">
                                                <p class="fw-semibold fs-20 text-fixed-white text-shadow mb-0">$25.2k</p>
                                                <p class="mb-0 fs-11 op-6 text-fixed-white">Contributions</p>
                                            </div>
                                            <div class="me-4">
                                                <p class="fw-semibold fs-20 text-fixed-white text-shadow mb-0">$11.43k</p>
                                                <p class="mb-0 fs-11 op-6 text-fixed-white">Comitted</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>  
                                ...
                                <div class="p-4 border-bottom border-block-end-dashed d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <span class="badge bg-primary-transparent m-1">Corporate</span> - 1200+ Employees
                                    </div>
                                </div>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="mb-0 text-center">
                                                <span class="avatar avatar-xxl avatar-rounded p-2 bg-light">
                                                    <img src="{{asset('build/assets/images/company-logos/4.png')}}" alt="" id="profile-img">
