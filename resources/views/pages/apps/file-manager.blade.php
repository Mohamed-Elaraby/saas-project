                    ...
                    <div class="file-manager-container p-2 gap-2 d-sm-flex">
                        <div class="file-manager-navigation">
                            ...
                            <div class="p-3 border-bottom">
                                <div class="input-group">
                                    <input type="text" class="form-control border-0" placeholder="Search Files" aria-describedby="button-addon02">
                                    <button class="btn btn-primary" type="button" id="button-addon02"><i class="ri-search-line"></i></button>
                                </div>
                            </div>
                            <div>
                                <ul class="list-unstyled files-main-nav fs-14" id="files-main-nav">
                                    <li class="active files-type">
                                        <a href="javascript:void(0)">
                                            <div class="d-flex align-items-center fs-14">
                                                ...
                                                <span class="badge bg-primary">201</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="files-type">
                                    ...
                                    <li class="mb-4 file-internal-storage">
                                        <div class="d-flex">
                                            ...
                                            <h5 class="fw-medium">Internal Storage</h5>
                                        </div>
                                        <div class="text-muted mb-2 d-flex align-items-center justify-content-between">
                                            <p class="mb-0"><span class="fw-bold fs-14">69.42GB</span> Used</p>
                                            <p class="fs-12 mb-0">63% Used</p>
                                        </div>
                                        <div class="progress progress-xs">
                                            <div class="progress-bar bg-info" role="progressbar" style="width: 63%" aria-valuenow="63" aria-valuemin="0" aria-valuemax="100">
                                            </div>
                                        </div>
                                        <p class="fs-12 mt-2 mb-0"> 51.04GB free</p>
                                    </li>
                                    <li class="p-0">
                                        <div class="filemanager-upgrade-storage gap-2 justify-content-around flex-wrap">
                                            <span>
                                                <img src="{{asset('build/assets/images/media/file-manager/2.png')}}" alt="">
                                            </span>
                                            <div class="text-default">
                                                <span class="fw-medium">Looking for storage options?</span>
                        ...
                        <div class="file-manager-folders">
                            <div class="d-flex p-3 flex-wrap gap-2 align-items-center justify-content-between border-bottom">
                                <div>
                                    <h6 class="fw-medium mb-0">All Files</h6>
                                </div>
                                            ...
                                            <div class="card-body p-3">
                                                <a href="javascript:void(0);">
                                                    <div class="text-center">
                                                        <div class="file-format-icon text-primary">
                                        ...
                                        <div class="card custom-card shadow-none">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                                    ...
                                                    <div class="text-default fw-medium ms-5">
                                                            147.45MB
                                                    </div>
                                                    <div class="ms-auto">
                                                        <div class="dropdown">
                                                            <button class="btn btn-sm btn-icon btn-primary-transparent btn-wave waves-light" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                        ...
                                                        <th scope="row">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">VID-5471511100-AY51.mp4</a>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        <td>Videos</td>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <a href="javascript:void(0);" data-bs-toggle="offcanvas"
                                                                    data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">IMG-414589992226-HJ45.jpeg</a>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        <td>Images</td>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <a href="javascript:void(0);" data-bs-toggle="offcanvas"
                                                                    data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">com4888-2024.zip</a>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        <td>Archives</td>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <a href="javascript:void(0);" data-bs-toggle="offcanvas"
                                                                    data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">AUD-45841-2024.mp3</a>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        <td>Archives</td>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <a href="javascript:void(0);" data-bs-toggle="offcanvas"
                                                                    data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Document-file-list.pdf</a>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        <td>Documents</td>
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        <div>
                                            ...
                                            <span class="fs-12 text-muted">This file contains 3 folder SCIFI.main & SCIFI.premium & SCIFI.featured and 42 images and layout styles are added in this update.</span>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
