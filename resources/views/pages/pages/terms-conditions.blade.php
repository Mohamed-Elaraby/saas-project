                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card overflow-hidden">
                                ...
                                <div class="card-body p-5">
                                    <div class=" text-primary h5 fw-medium mb-4">SciFi - Terms & Conditions
                                    </div>
                                    <div class="terms-conditions border p-3" id="terms-scroll">
                                        <div class="mb-4 fs-14">
                                            <p class="mb-3">

                                                <span class="fw-medium text-default">If you reside in the USA, </span>the SciFi 
                                                <a class="text-primary" href="javascript:void(0);"><u>Terms and Conditions</u></a> 
                                                comprise the following rules, and the <a class="text-primary" href="javascript:void(0);"><u>User Agreements</u></a> encompass the specified policies. The
                                                <a class="text-primary" href="javascript:void(0);"><u>SciFi Rules and Privacy Policies</u></a> are integrated with the conditions outlined below.
                                            </p>
                                            <p class="mb-0">
                                                <span class="fw-medium text-default">If you reside outside the USA, </span>the SciFi <a class="text-primary" href="javascript:void(0);"><u>Terms and Conditions</u></a> include the following rules and <a class="text-primary" href="javascript:void(0);"><u>User Agreements</u></a> encompass the following policies. The <a class="text-primary" href="javascript:void(0);"><u>SciFi Rules and Privacy Policies</u></a> are integrated with the conditions outlined below.
                                            </p>
                                        </div>
