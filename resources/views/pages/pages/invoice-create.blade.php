                                    ...
                                    <div class="row gy-3">
                                        <div class="col-xl-12">
                                            <div class="row gy-3">
                                                <div class="col-xl-3"> 
                                                    ...
                                                    <input type="text" class="form-control" id="invoice-number" placeholder="Inv No" value="#SPTA47512151">
                                                </div>
                                                <div class="col-xl-3">
                                                ...
                                                <div class="col-xl-3"> 
                                                    ...
                                                    <input type="text" class="form-control" id="invoice-due-amount" placeholder="Enter Amount" value="$15,457.12">
                                                </div>
                                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                                    ...
                                                    <div class="row gy-2">
                                                        <div class="col-xl-12">
                                                            <input type="text" class="form-control" id="Company-Name" placeholder="Company Name" value="Spruko Technologies Private Limited">
                                                        </div>
                                                        <div class="col-xl-12">
                                                ...
                                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 ms-auto">
                                                    <p class="dw-semibold mb-2">
                                                        Billing To :
                                                    </p>
                                                    <div class="row gy-2">
                                                        <div class="col-xl-12">
                                                            <input type="text" class="form-control" id="customer-Name" placeholder="Customer Name" value="James Lucas">
                                                        </div>
                                                        <div class="col-xl-12">
                                        ...
                                        <div class="col-xl-12">
                                            <div>
                                                ...
                                                <textarea class="form-control" id="invoice-note" rows="3">After the accounts payable team has verified and recorded the invoice, the final step is to submit it for approval before initiating the payment release.</textarea>
                                            </div>    
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-xl-12">
                                            <input type="text" class="form-control" id="invoice-payment-cardname" placeholder="Card Number" value="4581 7845 6565 XXXX">
                                            <label for="invoice-payment-cardname" class="form-label mb-0"><a class="text-danger fs-11 fw-medium" href="javascript:void(0);">Enter valid card number*</a></label>
                                        </div>
                                        <div class="col-xl-12">
