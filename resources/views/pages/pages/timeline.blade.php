                            ...
                            <ul class="timeline list-unstyled">
                                <li>
                                    <div class="timeline-time text-end">
                                        <span class="time d-inline-block">05:23</span>
                                    <span class="date">Thursday</span>
                                    </div>
                                    <div class="timeline-icon">
                                    <a href="javascript:void(0);"><i class="ri-attachment-2"></i></a>
                                    </div>
                                    <div class="timeline-body">
                                        <div class="text-muted fw-medium mb-2">
                                            19,Oct 2023
                                        </div>
                                        <div class="card custom-card mt-0 primary">
                                            <div class="card-body">
                                                <div class="d-flex align-items-top timeline-main-content flex-wrap flex-xl-nowrap mt-0">
                                                    <div class="avatar avatar-md online me-3 mt-sm-0 mt-4 flex-shrink-0">
                                                        <img alt="avatar" src="{{asset('build/assets/images/faces/4.jpg')}}">
                                                    </div>
                                                    <div class="flex-fill">
                                                        <div class="d-flex align-items-center">
                                                            <div class="mt-sm-0 mt-2">
                                                                <p class="mb-0 fs-14 fw-semibold"> Isabella Joe</p>
                                                                <p class="mb-0 text-muted fs-14">Submitted complete project and attached some<span class="badge bg-primary fw-semibold mx-1">files </span> to get aware of issues in the further implementation.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <li>
                                    <div class="timeline-time text-end">
                                        <span class="time d-inline-block">13:02</span>
                                    <span class="date">Saturday</span>
                                    </div>
                                    <div class="timeline-icon">
                                    <a href="javascript:void(0);"><i class="ri-edit-2-line"></i></a>
                                    </div>
                                    <div class="timeline-body">
                                        <div class="text-muted fw-medium mb-2"> 
                                            30,Oct 2023
                                        </div>
                                        <div class="card custom-card mt-0 secondary">
                                            <div class="card-body">
                                                <div class="d-flex align-items-top timeline-main-content flex-wrap flex-xl-nowrap mt-0">
                                                    <div class="avatar avatar-md online me-3 mt-sm-0 mt-4 flex-shrink-0">
                                                    ...
                                                    <div class="flex-fill">
                                                        <div class="d-flex align-items-center">
                                                            <div class="mt-sm-0 mt-2">
                                                                <p class="mb-0 fs-14 fw-semibold">Henrik Roy</p>
                                                                <p class="mb-0 text-muted fs-14">New Message is posted <span class="text-success fw-medium">#415001</span>, Alloted Team to collect the information</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <li>
                                    <div class="timeline-time text-end">
                                        <span class="time d-inline-block">15:09</span>
                                    <span class="date">YESTERDAY</span>
                                    </div>
                                    <div class="timeline-icon">
                                    <a href="javascript:void(0);"><i class="ri-chat-1-line"></i></a>
                                    </div>
                                    <div class="timeline-body">
                                        <div class="text-muted fw-medium mb-2">
                                            21,Nov 2023
                                        </div>
                                        <div class="card custom-card mt-0 warning">
                                            <div class="card-body">
                                                <div class="d-flex align-items-top timeline-main-content flex-wrap flex-xxl-nowrap mt-0">
                                                    <div class="avatar avatar-md online me-3 mt-sm-0 mt-4 flex-shrink-0">
                                                    ...
                                                    <div>
                                                        <div class="d-flex align-items-center">
                                                            <div class="mt-sm-0 mt-2">
                                                                <p class="mb-0 fs-14 fw-semibold">Jakob Stone</p>
                                                                <p class="mb-0 text-muted fs-14">Task Number: <span class="badge bg-danger-transparent fw-medium">A102H</span> Need to be complete by the Next week , because of added some additional improvements, corrections and more is required </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <li>
                                    <div class="timeline-time text-end">
                                        <span class="time d-inline-block">04:12</span>
                                    <span class="date">YESTERDAY</span>
                                    </div>
                                    <div class="timeline-icon">
                                    <a href="javascript:void(0);"><i class="ri-checkbox-circle-line"></i></a>
                                    </div>
                                    <div class="timeline-body">
                                        <div class="text-muted fw-medium mb-2">
                                            06,Dec 2023
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-top timeline-main-content flex-wrap flex-xl-nowrap mt-0">
                                                    ...
                                                    <div class="flex-fill">
                                                        <div class="d-flex align-items-center">
                                                            <div class="mt-sm-0 mt-2">
                                                                <p class="mb-0 fs-14 fw-semibold">Stella Ivy</p>
                                                                <p class="mb-0 text-muted fs-14">Verification has done ! Go through the documention that has been dropped in the mail <i class="ri-checkbox-circle-line text-success ms-1 fs-16 align-middle"></i></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mt-3 d-flex flex-wrap">
                                                    <a href="javascript:void(0);" class="border">
                                                        <div class="d-flex p-2 align-items-center gap-2 flex-wrap">
                                                            ...
                                                            <div class="">
                                                                <p class="mb-0 text-truncate text-primary">
                                                                    Documentation__File__8.pdf
                                                                </p>
                                                            </div>
                                                            <p class="ms-auto mb-0 fs-11 text-muted">
                                                                0.85MB
                                                            </p>
                                                        </div>
                                                    </a>
                                ...
                                <li>
                                    <div class="timeline-time text-end">
                                        <span class="time d-inline-block">08:33</span>
                                    <span class="date">TODAY</span>
                                    </div>
                                    <div class="timeline-icon">
                                    <a href="javascript:void(0);"><i class="ri-file-zip-line"></i></a>
                                    </div>
                                    <div class="timeline-body">
                                        <div class="text-muted fw-medium mb-2">
                                            12,Dec 2023
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-top timeline-main-content flex-wrap flex-xl-nowrap mt-0">
                                                    ...
                                                    <div class="flex-fill">
                                                        <div class="d-flex align-items-center">
                                                            <div class="mt-sm-0 mt-2">
                                                                <p class="mb-0 fs-14 fw-semibold">Braden Meir</p>
                                                                <p class="mb-0 text-muted fs-14">Uploaded 3 New Projects <span class="badge bg-success"> Get details</span> by Checking the online links.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <li>
                                    <div class="timeline-time text-end">
                                        <span class="time d-inline-block">14:40</span>
                                    <span class="date">TODAY</span>
                                    </div>
                                    <div class="timeline-icon">
                                    <a href="javascript:void(0);"><i class="ri-image-circle-line"></i></a>
                                    </div>
                                    <div class="timeline-body">
                                        <div class="text-muted fw-medium mb-2">
                                            12, Dec 2023
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-top timeline-main-content flex-wrap flex-xl-nowrap mt-0">
                                                    ...
                                                    <div class="flex-fill">
                                                        <div class="d-flex align-items-center">
                                                            <div class="mt-sm-0 mt-2">
                                                                <p class="mb-0 fs-14 fw-semibold"> Aurora Ellie </p>
                                                                <p class="mb-0 text-muted fs-14">Details on how to change the profile credentials. Follow the provided <a href="javascript:void(0);" class="text-secondary text-decoration-underline">Instructions</a> here.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
