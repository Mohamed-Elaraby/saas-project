                    ...
                    <div class="main-mail-container p-2 gap-2 d-flex">
                        <div class="mail-navigation border">
                            <div class="d-grid align-items-top p-3 border-bottom">
                                <button class="btn btn-secondary d-flex align-items-center justify-content-center" data-bs-toggle="modal"
                                data-bs-target="#mail-Compose">
                                    <i class="ri-edit-2-line fs-16 align-middle me-1"></i>Compose Mail
                                </button>
                                            ...
                                            <div class="modal-body px-4">
                                                <div class="row">
                                                    <div class="col-xl-6 mb-2">
                                                        ...
                                                        <input type="email" class="form-control" id="fromMail" value="jameslucas2345@gmail.com">
                                                    </div>
                                                    <div class="col-xl-6 mb-2">
                            ...
                            <div class="p-3 text-center border-block-end-dashed border-bottom">
                                <div>
                                ...
                                <div>
                                    <p class="fw-medium mb-0">Anthony</p>
                                    <p class="fs-13 mb-0">Anthony1992@gmail.com</p>
                                </div>
                            </div>
                            <div>
                                <ul class="list-unstyled mail-main-nav fs-13" id="mail-main-nav">
                                    <li class="px-0 pt-0">
                                    ...
                                    <li class="active mail-type">
                                        <a href="javascript:void(0);">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="badge bg-success-transparent">1,541</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="mail-type">
                                        <a href="javascript:void(0);">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="badge bg-primary-transparent">11</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="mail-type">
                                    ...
                                    <li class="mail-type">
                                        <a href="javascript:void(0);">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="badge bg-danger-transparent">02</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="mail-type">
                                    ...
                                    <li class="mail-type">
                                        <a href="javascript:void(0);">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="badge bg-warning-transparent">10</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="px-0">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            <div class="d-flex align-items-top lh-1">
                                                ...
                                                <div>
                                                    <p class="text-default fw-medium mb-1">Deborah</p>
                                                    <p class="fs-12 text-muted mb-0">Hello, How are you?</p>
                                                </div>
                                            </div>
                                        </a>    
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);">
                                            <div class="d-flex align-items-top lh-1">
                                                ...
                                                <div>
                                                    <p class="text-default fw-medium mb-1">Isabel</p>
                                                    <p class="fs-12 text-muted mb-0">Congratualtions &#128079;.</p>
                                                </div>
                                            </div>
                                        </a>    
                                    </li>
                        ...
                        <div class="total-mails border">
                            <div class="p-3 d-flex align-items-center border-bottom">
                                <div class="me-3">
                                    <input class="form-check-input check-all" type="checkbox" id="check-all" value="" aria-label="...">
                                </div>
                                <div class="flex-fill">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-icon btn-light btn-wave waves-light btn-sm" type="button"
                            ...
                            <div class="p-3 border-bottom">
                                <div class="input-group">
                                    <input type="text" class="form-control bg-light border-0" placeholder="Search Email" aria-describedby="button-addon01">
                                    <button class="btn btn-light" type="button" id="button-addon01"><i class="ri-search-line text-muted"></i></button>
                                </div>
                            </div>
                            <div class="mail-messages" id="mail-messages">
                                <ul class="list-unstyled mb-0 mail-messages-container">
                                    <li>
                                        <div class="d-sm-flex align-items-top text-truncate">
                                            <div class="me-3 mt-1 mail-message-list mb-2">
                                            ...
                                            <div class="flex-fill text-truncate">
                                                <a href="javascript:void(0);">
                                                    <p class="mb-1 fs-12">
                                                        Kingston <span
                                                            class="float-end text-muted fw-normal fs-11"><span class="me-2"><i class="ri-attachment-2 align-middle fs-12"></i></span>12:21PM<i class="ri-star-fill text-warning fs-12 op-4 ms-2"></i></span>
                                                    </p>
                                                </a>    
                                                <div class="mail-msg mb-0">
                                                    <span class="d-block mb-0 fw-medium text-truncate w-75 fs-14">Weekly Newsletter: Tech Insights and Updates</span>
                                                    <div
                                                        class="fs-11 op-6 text-muted text-wrap text-truncate mail-msg-content">Vestibulum fringilla dictum tellus sodales interdum. Sed ornare sed ex sed lacinia. Nam vitae nisi bibendum, pharetra augue qui                                                    
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-sm-flex align-items-top text-truncate">
                                            ...
                                            <div class="flex-fill text-truncate">
                                                <a href="javascript:void(0);">      
                                                    <p class="mb-1 fs-12">
                                                        Roberto <span
                                                            class="float-end text-muted fw-normal fs-11">03:00AM<i class="ri-star-fill fs-12 op-4 ms-2"></i></span>
                                                    </p>
                                                </a>    
                                                <div class="mail-msg mb-0">
                                                    <span class="d-block mb-0 fw-medium text-truncate w-75 fs-14">Exclusive Offers Inside! Limited-Time Deals Await You</span>
                                                    <div
                                                        class="fs-11 op-6 text-muted text-wrap text-truncate mail-msg-content">Vestibulum fringilla dictum tellus sodales interdum. Sed ornare sed ex sed lacinia. Nam vitae nisi bibendum, pharetra augue qui..
                                                    </div>
                                                </div>
                                    ...
                                    <li>
                                        <div class="d-sm-flex align-items-top text-truncate">
                                            ...
                                            <div class="flex-fill text-truncate">
                                                <a href="javascript:void(0);">
                                                    <p class="mb-1 fs-12">
                                                        Robin Keith <span class="badge bg-success align-middle">Promotion</span><span
                                                            class="float-end text-muted fw-normal fs-11">Yesterday, 05:23AM<i class="ri-star-fill fs-12 op-4 ms-2"></i></span>
                                                    </p>
                                                </a>    
                                                <div class="mail-msg mb-0">
                                                    <span class="d-block mb-0 fw-medium text-truncate w-75 fs-14">Please Verify Your Information</span>
                                                    <div
                                                        class="fs-11 op-6 text-muted text-wrap text-truncate mail-msg-content">Praesent non varius leo, sit amet viverra mauris. Etiam id dapibus tellus. Morbi eget mollis enim. 
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="d-sm-flex align-items-top text-truncate">
                                            ...
                                            <div class="flex-fill text-truncate">
                                                <a href="javascript:void(0);">
                                                    <p class="mb-1 fs-12">
                                                        Juliana <span class="badge bg-primary align-middle">Social</span><span
                                                            class="float-end text-muted fw-normal fs-11">30 Dec, 02:15PM<i class="ri-star-fill fs-12 op-4 ms-2"></i></span>
                                                    </p>
                                                </a>    
                                                <div class="mail-msg mb-0">
                                                    <span class="d-block mb-0 fw-medium text-truncate w-75 fs-14">Stay Informed with Our Latest Articles</span>
                                                    <div
                                                        class="fs-11 op-6 text-muted text-wrap text-truncate mail-msg-content">Praesent non varius leo, sit amet viverra mauris. Etiam id dapibus tellus. Morbi eget mollis enim.
                                                    </div>
                                                </div>
                                        ...
                                        <div class="d-sm-flex align-items-top text-truncate">
                                            ...
                                            <div class="flex-fill text-truncate">
                                                <a href="javascript:void(0);">
                                                    <p class="mb-1 fs-12">
                                                        Harvey <span
                                                            class="float-end text-muted fw-normal fs-11">08 Jan, 06:15AM<i class="ri-star-fill fs-12 op-4 ms-2"></i></span>
                                                    </p>
                                                </a>    
                                                <div class="mail-msg mb-0">
                                                    <span class="d-block mb-0 fw-medium text-truncate w-75 fs-14">Your Subscription Renewal Reminder</span>
                                                    <div
                                                        class="fs-11 op-6 text-muted text-wrap text-truncate mail-msg-content">Praesent non varius leo, sit amet viverra mauris. Etiam id dapibus tellus. Morbi eget mollis enim.
                                                    </div>
                                                </div>
                                    ...
                                    <li>
                                        <div class="d-sm-flex align-items-top text-truncate">
                                            ...
                                            <div class="flex-fill text-truncate">
                                                <a href="javascript:void(0);">
                                                    <p class="mb-1 fs-12">
                                                        Tommy Stuart <span class="badge bg-danger align-middle">Personal</span><span
                                                            class="float-end text-muted fw-normal fs-11">15 Jan, 05:11AM<i class="ri-star-fill fs-12 op-4 ms-2"></i></span>
                                                    </p>
                                                </a>    
                                                <p class="fs-12 mb-0">
                                                <div class="mail-msg mb-0">
                                                    <span class="d-block mb-0 fw-medium text-truncate w-75 fs-14">New Product Launch</span>
                                                    <div
                                                        class="fs-11 op-6 text-muted text-wrap text-truncate mail-msg-content">Praesent non varius leo, sit amet viverra mauris. Etiam id dapibus tellus. Morbi eget mollis enim.
                                                    </div>
                                                </div>
                                        ...
                                        <div class="d-sm-flex align-items-top text-truncate">
                                            ...
                                            <div class="flex-fill text-truncate">
                                                <a href="javascript:void(0);">
                                                    <p class="mb-1 fs-12">
                                                        Daisy <span
                                                            class="float-end text-muted fw-normal fs-11">18 Jan, 09:15AM<i class="ri-star-fill text-warning fs-12 op-4 ms-2"></i></span>
                                                    </p>
                                                </a>    
                                                <p class="fs-12 mb-0">
                                                <div class="mail-msg mb-0">
                                                    <span class="d-block mb-0 fw-medium text-truncate w-75 fs-14">Sneak Peek into Our Spring Collection</span>
                                                    <div
                                                        class="fs-11 op-6 text-muted text-wrap text-truncate mail-msg-content">Praesent non varius leo, sit amet viverra mauris. Etiam id dapibus tellus. Morbi eget mollis enim.
                                                    </div>
                                                </div>
                                        ...
                                        <div class="d-sm-flex align-items-top text-truncate">
                                            ...
                                            <div class="flex-fill text-truncate">
                                                <a href="javascript:void(0);">
                                                    <p class="mb-1 fs-12">
                                                        Jimmy <span
                                                            class="float-end text-muted fw-normal fs-11">19 Jan, 09:18PM<i class="ri-star-fill fs-12 op-4 ms-2"></i></span>
                                                    </p>
                                                </a>    
                                                <p class="fs-12 mb-0">
                                                <div class="mail-msg mb-0">
                                                    <span class="d-block mb-0 fw-medium text-truncate w-75 fs-14">Upgrade Your Membership Today</span>
                                                    <div
                                                        class="fs-11 op-6 text-muted text-wrap text-truncate mail-msg-content">Praesent non varius leo, sit amet viverra mauris. Etiam id dapibus tellus. Morbi eget mollis enim.
                                                    </div>
                                                </div>
                        ...
                        <div class="mails-information border">
                            <div class="mail-info-header d-flex flex-nowrap gap-2 align-items-center">
                                <div class="me-1">
                                ...
                                <div class="flex-fill">
                                    <h6 class="mb-0 fw-medium">Roberto</h6>
                                    <span class="text-muted fs-12">Roberto1458@gmail.com</span>
                                </div>
                                <div class="mail-action-icons">
                                    <button class="btn btn-icon btn-outline-light border btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Starred">
                                        <i class="ri-star-line align-middle fs-12"></i>
                                    </button>
                                    <button class="btn btn-icon btn-outline-light border btn-sm ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Archive">
                                        <i class="ri-inbox-archive-line align-middle fs-12"></i>
                                    </button>
                                    <button class="btn btn-icon btn-outline-light border btn-sm ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Report spam">
                                        <i class="ri-spam-2-line align-middle fs-12"></i>
                                    </button>
                                    <button class="btn btn-icon btn-outline-light border btn-sm ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete">
                                        <i class="ri-delete-bin-line align-middle fs-12"></i>
                                    </button>
                                    <button class="btn btn-icon btn-outline-light border btn-sm ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Reply">
                                        <i class="ri-reply-line align-middle fs-12"></i>
                                    </button>
                                </div>
                                <div class="responsive-mail-action-icons">
                                    <div class="dropdown">
                                        <button class="btn btn-icon btn-light btn-wave waves-light btn-sm waves-effect waves-light" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            <i class="ti ti-dots-vertical fs-12"></i>
                                        </button>
                                        <ul class="dropdown-menu">
                                    ...
                                    <button class="btn btn-icon btn-light btn-sm ms-1 close-button">
                                        <i class="ri-close-line"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="mail-info-body p-4" id="mail-info-body">
                                <div class="d-sm-flex d-block align-items-center justify-content-between mb-4 gap-1">
                                    <div>
                                        <p class="fs-20 fw-medium mb-0">Insights and Next Steps for Our Upcoming Projects</p>
                                    </div>
                                    <div class="float-end">
                                        <span class="fs-10 text-muted op-8 text-nowrap">12 Dec 2023,02:00PM</span>
                                    </div>
                                </div>
                                <div class="main-mail-content mb-4">
                                    <p class="fs-14 fw-medium mb-4">Hi, Mr Anthony Greetings &#128075;</p>
                                    <p class="mb-2 fs-12 text-muted">The comprehensive project update presentation, highlighting our recent accomplishments, ongoing initiatives, and upcoming milestones. Your valuable insights and feedback during our last meeting were instrumental in shaping the direction of our efforts.</p>
                                    <p class="mb-2 fs-12 text-muted">Additionally, I've attached relevant documents, including the latest financial report and project timeline. </p>
                                    <p class="mb-0 mt-4">
                                        <span class="d-block">Regards,</span>
                                        <span class="d-block">Roberto</span>
                                    </p>
                                </div>
                                <div class="mail-attachments mb-4">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="mb-0"> 
                                            <span class="fs-14 fw-medium"><i class="ri-attachment-2 me-1 align-middle"></i>Attachments (1.45mb):</span>
                                        </div>
                                        <div>
                                            <a href="javascript:void(0);" class="text-secondary fs-13">Download All</a>
                                        </div>
                                    </div>    
                                    <div class="mt-2 d-flex flex-wrap">
                                        <div class="mail-attachment flex-grow-1 border mb-1">
                                            ...
                                            <div class="ms-auto text-success me-2">
                                                <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-title="Download"><i class="ri-download-cloud-line"></i></a>
                                            </div>
                                        </div>
                                        <div class="mail-attachment flex-grow-1 ms-2 border mb-1">
                            ...
                            <div class="mail-info-footer d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                ...
                                <div>
                                    <button class="btn btn-secondary">
                                        <i class="ri-share-forward-line me-1 d-inline-block align-middle"></i><span class="d-xl-none d-xxl-inline-block">Forward</span>
                                    </button>
                                    <button class="btn btn-danger ms-1">
                                        <i class="ri-reply-all-line me-1 d-inline-block align-middle"></i><span class="d-xl-none d-xxl-inline-block">Reply</span>
                                    </button>
                                </div>
                            </div>
                        </div>
