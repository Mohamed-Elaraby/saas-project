                        ...
                        <div class="row">
                            <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-8">
                                <div class="py-lg-5">
                                    ...
                                    <a href="{{url('index')}}" class="m-1 btn btn-lg btn-secondary">
                                        <i class="ri-eye-line me-2 align-middle"></i>
                                        View Demos
                                    </a>
                                    <a href="{{url('index')}}" class="m-1 btn btn-lg bg-primary-transparent">
                    ...
                    <div class="row gx-5 mx-0">
                        <div class="col-xl-4">
                            <div class="home-proving-image">
                                <img src="{{asset('build/assets/images/media/landing/2.png')}}" alt="" class="img-fluid rounded">
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-sm-6 col-12 mb-md-0 mb-3">
                            <div class="px-4">
                                <p class="fw-medium mb-3"><a href="{{url('index')}}"><img src="{{asset('build/assets/images/brand-logos/desktop-dark.png')}}" alt="" class="landing-footer-logo"></a></p>
