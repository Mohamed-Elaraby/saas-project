                    ...
                    <div class="row justify-content-center mb-5">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-xl-6">
                                    <div class="text-center p-3 faq-header mb-4">
                                        <h5 class="mb-1 text-primary op-5 fw-medium">FAQ's</h5>
                                        <h4 class="mb-1 fw-medium">Frequently Asked Questions</h4>
                                        <p class="fs-15 text-muted op-7">We have put together a list of common questions to
                        ...
                        <div class="col-xl-10">
                            <div class="card custom-card">
                                ...
                                <div
                                    class="card-header d-sm-flex d-block border-block-end-dashed justify-content-center text-center">
                                    <ul class="nav nav-tabs nav-tabs-header mb-0 d-sm-flex d-block" role="tablist">
                                        <li class="nav-item m-1">
                                            <a class="nav-link active" data-bs-toggle="tab" role="tab" aria-current="page"
                                                href="#general-faqs" aria-selected="true">General</a>
                                        </li>
                                        <li class="nav-item m-1">
                                            <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                                href="#support-faqs" aria-selected="true">Support</a>
                                        </li>
                                        <li class="nav-item m-1">
                                            <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                                href="#others-faqs" aria-selected="true">Others</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane pb-0 border-0 show active" id="general-faqs" role="tabpanel">
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="headingcustomicon2One">
                                                            <button class="accordion-button" type="button"
                                                                ...
                                                                <i
                                                                    class="ri-question-line me-2 text-primary fs-16"></i>How
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="headingcustomicon2Two">
                                                            <button class="accordion-button collapsed" type="button"
                                                                ...
                                                                <i
                                                                    class="ri-question-line me-2 text-primary fs-16"></i>Can
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="headingcustomicon2Four">
                                                            <button class="accordion-button collapsed" type="button"
                                                                ...
                                                                <i class="ri-question-line me-2 text-primary fs-16"></i>
                                                                How do I track the performance a page?
                                                            </button>
                                                        </h2>
                                                        <div id="collapsecustomicon2Four"
                                                            class="accordion-collapse collapse"
                                        ...
                                        <div class="tab-pane pb-0 border-0" id="support-faqs" role="tabpanel">
                                            <div class="card-header">
                                                <div class="card-title">
                                                    Customer Support ?
                                                </div>
                                                ...
                                                <div class="accordion accordion-customicon1 accordion-primary"
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="headingcustomicon3One">
                                                            <button class="accordion-button collapsed" type="button"
                                                                data-bs-toggle="collapse"
                                                                data-bs-target="#collapsecustomicon3One"
                                                                aria-expanded="false"
                                                                aria-controls="collapsecustomicon3One">
                                                                <i
                                                                    class="ri-question-line me-2 text-primary fs-16"></i>Is
                                                                there a policy for subscriptions?
                                                            </button>
                                                        </h2>
                                                        <div id="collapsecustomicon3One"
                                                            class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="headingcustomicon3Two">
                                                            <button class="accordion-button" type="button"
                                                                data-bs-toggle="collapse"
                                                                data-bs-target="#collapsecustomicon3Two"
                                                                aria-expanded="true"
                                                                aria-controls="collapsecustomicon3Two">
                                                                <i
                                                                    class="ri-question-line me-2 text-primary fs-16"></i>Are
                                                                there pre-built data visualization components?
                                                            </button>
                                                        </h2>
                                                        <div id="collapsecustomicon3Two"
                                                            class="accordion-collapse collapse show"
                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapsecustomicon3Three"
                                                            class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="headingcustomicon3Four">
                                                            <button class="accordion-button collapsed" type="button"
                                                                data-bs-toggle="collapse"
                                                                data-bs-target="#collapsecustomicon3Four"
                                                                aria-expanded="false"
                                                                aria-controls="collapsecustomicon3Four">
                                                                <i
                                                                    class="ri-question-line me-2 text-primary fs-16"></i>What
                                                                support options are available for landing page services?
                                                            </button>
                                                        </h2>
                                                        <div id="collapsecustomicon3Four"
                                                            class="accordion-collapse collapse"
                                        ...
                                        <div class="tab-pane pb-0 border-0" id="others-faqs" role="tabpanel">
                                            <div class="card-header">
                                                <div class="card-title">
                                                    Others ?
                                                </div>
                                                ...
                                                <div class="accordion accordion-customicon1 accordion-primary"
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="headingcustomicon4Two">
                                                            <button class="accordion-button" type="button"
                                                                data-bs-toggle="collapse"
                                                                data-bs-target="#collapsecustomicon4Two"
                                                                aria-expanded="true"
                                                                aria-controls="collapsecustomicon4Two">
                                                                <i
                                                                    class="ri-question-line me-2 text-primary fs-16"></i>What
                                                                if I have specific customization needs for my page?
                                                            </button>
                                                        </h2>
                                                        <div id="collapsecustomicon4Two"
                                                            class="accordion-collapse collapse show"
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="headingcustomicon4One">
                                                            <button class="accordion-button collapsed" type="button"
                                                                data-bs-toggle="collapse"
                                                                data-bs-target="#collapsecustomicon4One"
                                                                aria-expanded="false"
                                                                aria-controls="collapsecustomicon4One">
                                                                <i
                                                                    class="ri-question-line me-2 text-primary fs-16"></i>How
                                                                do I get technical assistance for issues with my page?
                                                            </button>
                                                        </h2>
                                                        <div id="collapsecustomicon4One"
                                                            class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="headingcustomicon4Three">
                                                            <button class="accordion-button collapsed" type="button"
                                                                data-bs-toggle="collapse"
                                                                data-bs-target="#collapsecustomicon4Three"
                                                                aria-expanded="false"
                                                                aria-controls="collapsecustomicon4Three">
                                                                <i
                                                                    class="ri-question-line me-2 text-primary fs-16"></i>What
                                                                is included in the subscription service?
                                                            </button>
                                                        </h2>
                                                        <div id="collapsecustomicon4Three"
                                                            class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapsecustomicon4Four"
                                                            class="accordion-collapse collapse"
                                ...
                                <div class="card-footer text-center border-block-start-dashed border-top">
                                    <a href="javascript:void(0);"
                                        class="text-decoration-underline text-primary text-center"> Load More</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-10">
                                    ...
                                    <div class="row gy-3 justify-content-center">
                                        <div class="col-xl-8">
                                            <div class="p-3 border mb-2">
                                                ...
                                                <label for="user-email" class="form-label mt-3">Email Id</label>
                                                <input type="text" class="form-control" id="user-email"
                                                    placeholder="Enter Email">
                                                <label for="text-area" class="form-label mt-3">Textarea</label>
                                                <textarea class="form-control" placeholder="Enter your question here"
                                                    id="text-area" rows="2"></textarea>
                                                <button class="btn btn-primary btn-wave mt-3">Post Your Question</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
