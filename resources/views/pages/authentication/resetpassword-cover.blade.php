                        ...
                        <div class="col-xxl-6 col-xl-9 col-lg-6 col-md-6 col-sm-8 col-12">
                            <div class="card custom-card shadow-none my-4">
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <p class="mb-4 text-muted op-7 fw-normal text-center fs-14">Hello Anthony!</p>
                                    <div class="row gy-3">
                                        <div class="col-xl-12">
                                    ...
                                    <div class="d-grid mt-4">
                                        <a href="{{url('signin-basic')}}" class="btn btn-primary">Create</a>
                                    </div>
                                    <div class="text-center">
                                        <p class="text-muted mt-3">Remembered your password? <a href="{{url('signin-basic')}}" class="text-primary">Sign In</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
