                            ...
                            <div class="card custom-card shadow-none my-4">
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div class="d-flex mb-3 justify-content-between gap-2 flex-wrap flex-lg-nowrap">
                                        ...
                                        <button class="btn btn-lg btn-light-ghost border d-flex align-items-center justify-content-center flex-fill">
                                            <span class="avatar avatar-xs flex-shrink-0 invert-1">
                                    ...
                                    <div class="text-center">
                                        <p class="text-muted mt-3 mb-0">Dont have an account? <a href="{{url('signup-cover')}}" class="text-primary">Sign Up</a></p>
                                    </div>
