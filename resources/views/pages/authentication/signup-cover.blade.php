                        ...
                        <div class="col-xxl-6 col-xl-9 col-lg-6 col-md-6 col-sm-8 col-12">
                            <div class="card custom-card shadow-none my-4">
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div class="d-flex mb-3 justify-content-between gap-2 flex-wrap">
                                        <button class="btn btn-lg btn-light-ghost border d-flex align-items-center justify-content-center flex-fill">
                                            ...
                                            <span class="lh-1 ms-2 fs-13 text-default text-nowrap">Signup with Google</span>
                                        </button>
                                        <button class="btn btn-lg btn-light-ghost border d-flex align-items-center justify-content-center flex-fill">
                                            <span class="avatar avatar-xs invert-1">
                                                <img src="{{asset('build/assets/images/media/apps/apple.png')}}" alt="">
                                            </span>
                                            <span class="lh-1 ms-2 fs-13 text-default text-nowrap">Signup with Apple</span>
                                        </button>
                                    </div>
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <div class="form-check mt-3">
                                                ...
                                                <label class="form-check-label text-muted fw-normal fs-14" for="defaultCheck1">
                                                    By creating a account you agree to our <a href="terms-conditions')}}" class="text-success"><u>Terms & Conditions</u></a> and <a class="text-success"><u>Privacy Policy</u></a>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <p class="text-muted mt-3 mb-0">Already have an account? <a href="{{url('signin-cover')}}" class="text-primary">Sign In</a></p>
                                    </div>
