        ...
        <!-- Prism Code -->
                                ...
                                <div class="col-xl-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <p><a class="pe-none text-primary fw-medium text-decoration-underline" tabindex="-1" aria-disabled="true">This link</a> can not be clicked.</p>
                                            ...
                                            <p class="pe-none mb-0"><a tabindex="-1" class="text-primary fw-medium text-decoration-underline" aria-disabled="true">This link</a> can not be clicked because the <code>pointer-events</code> property is inherited from its parent. However, <a href="javascript:void(0);" class="pe-auto">this link</a> has a <code>pe-auto</code> class and can be clicked.</p>
                                        </div>
                                        <div class="card-footer d-none border-top-0">
        <!-- Prism Code -->
        <pre class="language-html"><code class="language-html"> &lt;p&gt;&lt;a class="pe-none text-primary fw-medium text-decoration-underline" tabindex="-1" aria-disabled="true"&gt;This link&lt;/a&gt; can not be clicked.&lt;/p&gt;
            &lt;p&gt;&lt;a href="javascript:void(0);" class="pe-auto text-primary fw-medium text-decoration-underline"&gt;This link&lt;/a&gt; can be clicked (this is default behavior).&lt;/p&gt;
