                        ...
                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Angela McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage</p>
                                    <a href="javascript:void(0);" class="btn btn-primary">Read More</a>
                                </div>
                            </div>
                            <div class="card custom-card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <div class="bottom-left"></div>
                                <div class="bottom-right"></div>
                                <div class="card-header justify-content-between border-bottom-0 pb-3">
                    ...
                    <div class="row">
                        <div class="col-xl-3">
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card border border-success mb-3 custom-card">
                                        <div class="card-header bg-transparent border-bottom border-success pb-2">Header</div>
                            ...
                            <div class="card custom-card overlay-card">
                                ...
                                <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                    <div class="card-body text-fixed-white">
                                        ...
                                        <div class="card-text mb-2 d-none d-md-block">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even.</div>
                                        <div class="card-text">Last updated 3 mins ago</div>
                                    </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card overlay-card">
                                ...
                                <div class="card-img-overlay d-flex flex-column p-0">
                                    ...
                                    <div class="card-body text-fixed-white overflow-auto">
                    ...
                    <div class="row">
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <p class="card-text mb-0 fs-14 fw-medium">Atharva Ayyan.</p>
                        ...
                        <div class="col-xxl-3 col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="bottom-right"></div>
                                <a href="javascript:void(0);" class="card-anchor"></a>
                                <img src="{{asset('build/assets/images/media/media-21.jpg')}}" class="card-img-top" alt="...">
                                <div class="card-body">
