                                        ...
                                        <div class="col-xl-6">
                                            <div class="alert alert-primary overflow-hidden p-0" role="alert">
                                                <div class="p-3 bg-primary text-fixed-black d-flex justify-content-between">
                                                    <h6 class="aletr-heading mb-0 text-fixed-black">Thank you for reporting this.</h6>
                                                 ...
                                                 w-100">
                                                    ...
                                                    <div class="fs-12 d-inline-flex">
                                                        <a href="javascript:void(0);" class="
                                                         fw-medium text-fixed-black me-2 op-7">cancel</a>
                                                        <a href="javascript:void(0);" class="
                                                         fw-medium text-fixed-black">open</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="
                                                 w-100">
                                                    ...
                                                    <div class="fs-12">
                                                        <a href="javascript:void(0);" class="
                                                         fw-medium me-2 text-fixed-black">close</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card border-0">
                                        <div class="alert alert-solid-warning border border-warning mb-0 p-2">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="text-fixed-black w-100">
                                                    ...
                                                    <div class="fs-12 d-inline-flex">
                                                        <a href="javascript:void(0);" class="text-fixed-black fw-medium me-2 op-7">skip</a>
                                                        <a href="javascript:void(0);" class="text-fixed-black fw-medium">open</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
