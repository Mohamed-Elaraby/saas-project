...
<!-- Prism Code -->
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="toast align-items-center colorscemes-toast text-bg-primary border-0 fade show mb-4"
                                    ...
                                    <div class="toast align-items-center colorscemes-toast text-bg-warning border-0 fade show mb-4"
                                        role="alert" aria-live="assertive" aria-atomic="true">
                                        <div class="d-flex">
                                            <div class="toast-body">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-html"><code class="language-html">&lt;div class="toast align-items-center colorscemes-toast text-bg-primary border-0 fade show mb-4"
    role="alert" aria-live="assertive" aria-atomic="true"&gt;
    &lt;div class="d-flex"&gt;
        &lt;div class="toast-body"&gt;
            Hello, world! This is the Primary toast message.
                                    ...
                                    <div class="toast-container position-fixed top-0 end-0 p-3">
                                        <div id="primaryToast" class="toast colored-toast bg-primary-transparent" role="alert" aria-live="assertive"
                                            ...
                                            <div class="toast-header bg-primary">
                                                <img class="bd-placeholder-img rounded me-2" src="{{asset('build/assets/images/brand-logos/toggle-logo-dark.png')}}" alt="...">
                                                <strong class="me-auto">SciFi</strong>
                                                <button type="button" class="btn-close" data-bs-dismiss="toast"
                                                    aria-label="Close"></button>
                                            </div>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="toast-container position-fixed top-0 end-0 p-3">
                                        ...
                                        <div id="solid-secondaryToast" class="toast colored-toast bg-secondary" role="alert" aria-live="assertive"
                                            aria-atomic="true">
                                            <div class="toast-header bg-secondary">
                                                <img class="bd-placeholder-img rounded me-2" src="{{asset('build/assets/images/brand-logos/toggle-logo-dark.png')}}" alt="...">
                                                <strong class="me-auto">SciFi</strong>
                                        ...
                                        <div id="solid-warningToast" class="toast colored-toast bg-warning" role="alert" aria-live="assertive"
                                            aria-atomic="true">
                                            <div class="toast-header bg-warning">
                                                <img class="bd-placeholder-img rounded me-2" src="{{asset('build/assets/images/brand-logos/toggle-logo-dark.png')}}" alt="...">
                                                <strong class="me-auto">SciFi</strong>
                                        ...
                                        <div id="solid-infoToast" class="toast colored-toast bg-info" role="alert" aria-live="assertive"
                                            aria-atomic="true">
                                            <div class="toast-header bg-info">
                                                <img class="bd-placeholder-img rounded me-2" src="{{asset('build/assets/images/brand-logos/toggle-logo-dark.png')}}" alt="...">
                                                <strong class="me-auto">SciFi</strong>
                                        ...
                                        <div id="solid-successToast" class="toast colored-toast bg-success" role="alert" aria-live="assertive"
                                            aria-atomic="true">
                                            <div class="toast-header bg-success">
                                                <img class="bd-placeholder-img rounded me-2" src="{{asset('build/assets/images/brand-logos/toggle-logo-dark.png')}}" alt="...">
                                                <strong class="me-auto">SciFi</strong>
                                        ...
                                        <div id="solid-dangerToast" class="toast colored-toast bg-danger" role="alert" aria-live="assertive"
                                            aria-atomic="true">
                                            <div class="toast-header bg-danger">
                                                <img class="bd-placeholder-img rounded me-2" src="{{asset('build/assets/images/brand-logos/toggle-logo-dark.png')}}" alt="...">
                                                <strong class="me-auto">SciFi</strong>
                                    ...
                                    <div class="toast-container position-fixed top-0 start-0 p-3">
                                        <div id="topleft-Toast" class="toast colored-toast bg-primary-transparent text-primary" role="alert" aria-live="assertive"
                                            ...
                                            <div class="toast-header bg-primary text-fixed-black">
                                                <img class="bd-placeholder-img rounded me-2" src="{{asset('build/assets/images/brand-logos/toggle-logo-white.png')}}" alt="...">
                                                <strong class="me-auto">SciFi</strong>
                                                <button type="button" class="btn-close" data-bs-dismiss="toast"
                                                    aria-label="Close"></button>
                                            </div>
