...
@section('styles')
        ...
        <!-- Gantt Css -->
        <link rel="stylesheet" href="{{asset('build/assets/libs/frappe-gantt/frappe-gantt.min.css')}}">
                ...
                <div class="container-fluid">
                                ...
                                <div class="col-xl-3">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <span class="d-block mb-1 fs-13">Total Time On Project</span>
                                            <h4 class="mb-0 fw-medium d-flex align-items-center justify-content-between gap-2">148:00h<span class="text-success fs-11 ms-auto">+0.67%<i class="ri-arrow-up-line"></i></span></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <span class="d-block mb-1 fs-13">Total Earnings</span>
                                            <h4 class="mb-0 fw-medium d-flex align-items-center justify-content-between gap-2">$12,563.5<span class="text-danger fs-11 ms-auto">-0.22%<i class="ri-arrow-up-line"></i></span></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-start justify-content-between mb-3">
                                                <span class="avatar bg-primary-transparent">
                                                    <i class="ri-timer-2-line fs-5"></i>
                                                </span>
                                                <div class="dropdown"> 
                                                    <a aria-label="anchor" href="javascript:void(0);" class="op-4" data-bs-toggle="dropdown" aria-expanded="true"> 
                                                        <i class="bi bi-grid text-primary"></i>
                                            ...
                                            <span class="d-block mb-1 fs-13">Cost</span>
                                            <h4 class="mb-0 fw-medium d-flex align-items-center justify-content-between gap-2">$6,156.38<span class="text-success fs-11 ms-auto">+1.03%<i class="ri-arrow-up-line"></i></span></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <span class="d-block mb-1 fs-13">Productivity</span>
                                            <h4 class="mb-0 fw-medium d-flex align-items-center justify-content-between gap-2">95.5$<span class="text-success fs-11 ms-auto">+2.45%<i class="ri-arrow-up-line"></i></span></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                        ...
                                        <div class="card-body">
                                            <div class="title-head mb-4">
                                                <div class="storage-percent">
                                                    <div class="progress-stacked progress-xl mb-3 rounded-0">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="fs-13 mb-1">Total Number of Projects</div>
                                                        <div class="fw-semibold fs-14 mb-1">18,643</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <ul class="row list-unstyled mb-0 gy-3 project-categories-list">
                                                <li class="col-xl-6">
                                                    <span class="mb-0 fs-13 me-1">UI Projects</span>
                                                    <span class="text-success fw-semibold fs-12">
                                                        <span class="">(4,934)</span>
                                                    </span>
                                                </li>
                                                <li class="col-xl-6">
                                                    <span class="mb-0 fs-13 me-1">UX Projects</span>
                                                    <span class="text-danger fw-semibold fs-12">
                                                        <span class="">(2,790)</span>
                                                    </span>
                                                </li>
                                                <li class="col-xl-6">
                                                    <span class="mb-0 fs-13 me-1">Finance</span>
                                                    <span class="text-success fw-semibold fs-12">
                                                        <span class="">(4,200)</span>
                                                    </span>
                                                </li>
                                                <li class="col-xl-6 mb-xl-0">
                                                    <span class="mb-0 fs-13 me-1">Banking</span>
                                                    <span class="text-success fw-semibold fs-12">
                                                        <span class="">(7,242)</span>
                                                    </span>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <ul class="list-unstyled project-transactions-card"> 
                                                <li> 
                                                    <div class="d-flex align-items-top"> 
                                                        <div class="me-3"> 
                                                            <span class="avatar avatar-md bg-primary-transparent fs-16"> S </span> 
                                                        </div> 
                                                        <div class="flex-fill"> 
                                                            <span class="d-block fw-medium">Ayyan Cowall</span> 
                                                            <span class="d-block text-muted fs-11">Feb 28,2024 - 12:54PM</span> 
                                                        </div> 
                                                        <div> 
                                                ...
                                                <li> 
                                                    <div class="d-flex align-items-top"> 
                                                        <div class="me-3"> 
                                                            <span class="avatar avatar-md bg-primary-transparent fs-16"> M </span> 
                                                        </div> 
                                                        <div class="flex-fill"> 
                                                            <span class="d-block fw-medium">Aldous Cason</span> 
                                                            <span class="d-block text-muted fs-11">Mar 28,2024 - 10:14AM</span> 
                                                        </div> 
                                                        <div> 
                                                ...
                                                <li> 
                                                    <div class="d-flex align-items-top"> 
                                                        <div class="me-3"> 
                                                            <span class="avatar avatar-md bg-primary-transparent fs-16"> G </span> 
                                                        </div> 
                                                        <div class="flex-fill"> 
                                                            <span class="d-block fw-medium">Gabriel Shin</span> 
                                                            <span class="d-block text-muted fs-11">Mar 16,2024 - 05:27PM</span> 
                                                        </div> 
                                                        <div> 
                                                ...
                                                <li> 
                                                    <div class="d-flex align-items-top"> 
                                                        <div class="me-3"> 
                                                            <span class="avatar avatar-md bg-primary-transparent fs-16"> Y </span> 
                                                        </div> 
                                                        <div class="flex-fill"> 
                                                            <span class="d-block fw-medium">Yohasimi Nakiyaro</span> 
                                                            <span class="d-block text-muted fs-11">Mar 19,2024 - 04:45PM</span> 
                                                        </div> 
                                                        <div> 
                                                ...
                                                <li> 
                                                    <div class="d-flex align-items-top"> 
                                                        <div class="me-3"> 
                                                            <span class="avatar avatar-md bg-primary-transparent fs-16"> B </span> 
                                                        </div> 
                                                        <div class="flex-fill"> 
                                                            <span class="d-block fw-medium">Brenda Lynn</span> 
                                                            <span class="d-block text-muted fs-11">Mar 10,2024 - 05:25PM</span> 
                                                        </div> 
                                                        <div> 
                    ...
                    <div class="row">
                        <div class="mb-4 d-flex align-items-center justify-content-between"> 
                            <h6 class="fw-semibold mb-0">Ongoing Projects :</h6> 
                            <div> 
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex gap-3 align-items-start mb-3">
                                        ...
                                        <div class="flex-fill">
                                            <h6>Project Nebula<span class="badge bg-white-transparent ms-2">Opened Yesterday</span></h6>
                                            <div><span>28 Tasks</span><span class="m-2 text-primary fs-12">11 Nov 2024</span></div>
                                        </div>
                                        <div class="d-flex align-items-start lh-1">
                                            <div class="stars-main me-3"> <i class="ri-star-fill star"></i> </div>
                                            <div class="dropdown"> 
                                                <a aria-label="anchor" href="javascript:void(0);" class="op-4" data-bs-toggle="dropdown" aria-expanded="true"> 
                                                    <i class="bi bi-grid text-primary"></i>
                                                </a> 
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex gap-3 align-items-start mb-3">
                                        ...
                                        <div class="flex-fill">
                                            <h6>Web Designing <span class="badge bg-white-transparent ms-2">Opened 2 Days ago</span></h6>
                                            <div><span>16 Tasks</span><span class="m-2 text-primary fs-12">12 May 2024</span></div>
                                        </div>
                                        <div class="d-flex align-items-start lh-1">
                                            <div class="stars-main me-3"> <i class="ri-star-fill star"></i> </div>
                                            <div class="dropdown"> 
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex gap-3 align-items-start mb-3">
                                        ...
                                        <div class="flex-fill">
                                            <h6>Operation Celestial<span class="badge bg-white-transparent ms-2">Opened Today</span></h6>
                                            <div><span>28 Tasks</span><span class="m-2 text-primary fs-12">16 Feb 2024</span></div>
                                        </div>
                                        <div class="d-flex align-items-start lh-1">
                                            <div class="stars-main me-3"> <i class="ri-star-fill star"></i> </div>
                                            <div class="dropdown"> 
                                    ...
                                    <div class="d-flex align-items-start justify-content-between mb-3">
                                        ...
                                        <div class="text-end">
                                            <span class="d-block">Due date</span>
                                            <span class="d-block text-danger fw-semibold fs-13">30,Feb 2024</span>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="d-flex align-items-center mb-1 justify-content-between">
                                            <span class="d-block">Project Progress</span>
                                            <span class="d-block fs-12">68%</span>
                                        </div>
                                        <div class="progress progress-xs" role="progressbar" aria-valuenow="68" aria-valuemin="0" aria-valuemax="100">
                                        ...
                                        <table class="table text-nowrap table-borderless table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><span class="badge bg-primary-transparent">On Hold</span></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="hstack gap-2 fs-15">
                                                            <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-primary-light"><i class="ri-download-2-line"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge bg-primary-transparent">Under Review</span></td>
                                                    <td>
                                                        <div class="progress progress-xs">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge bg-primary-transparent">Deployment</span></td>
                                                    <td>
                                                        <div class="progress progress-xs">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge bg-primary-transparent">Not Started</span></td>
                                                    <td>
                                                        <div class="progress progress-xs">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge bg-primary-transparent">Cancelled</span></td>
                                                    <td>
                                                        <div class="progress progress-xs">
                                                ...
                                                <tr>
                                                    <th scope="row"><input class="form-check-input" type="checkbox" id="checkboxNoLabel16" value="" aria-label="..."></th>
                                                    <td>
                                                        Titan Frontier
                                                    </td>
                                                    <td>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-header justify-content-between">
                                    ...
                                    <div class="btn-group flex-wrap">
                                        <button id="quarter-day" class="btn btn-primary-light btn-sm">Quarter Day</button>
                                        <button id="half-day" class="btn btn-primary-light btn-sm">Half Day</button>
                                        <button id="day" class="btn btn-primary-light btn-sm active">Day</button>
                                        <button id="week" class="btn btn-primary-light btn-sm">Week</button>
                                        <button id="month" class="btn btn-primary-light btn-sm">Month</button>
                                        <button id="yearID" class="btn btn-primary-light btn-sm">Year</button>
                                    </div>
                                </div>
                                <div class="card-body">
...
@section('scripts')
        ...
        <!-- Gantt Chart -->
        <script src="{{asset('build/assets/libs/frappe-gantt/frappe-gantt.min.js')}}"></script>
