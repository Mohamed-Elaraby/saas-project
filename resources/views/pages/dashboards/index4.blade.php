                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center gap-3 flex-wrap">
                                        ...
                                        <div class="flex-fill">
                                            ...
                                            <span class="d-block fs-12 text-success fw-medium"><i class="ti ti-arrow-narrow-up"></i>0.29% This Month</span>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center gap-3 flex-wrap">
                                        ...
                                        <div class="flex-fill">
                                            ...
                                            <span class="d-block text-muted mb-1">Total Revenue</span>
                                            <span class="d-block fs-12 text-success fw-medium"><i class="ti ti-arrow-narrow-up"></i>1.25% This Month</span>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center gap-3 flex-wrap">
                                        ...
                                        <div class="flex-fill">
                                            ...
                                            <span class="d-block text-muted mb-1">Page Views</span>
                                            <span class="d-block fs-12 text-danger fw-medium"><i class="ti ti-arrow-narrow-down"></i>0.05% This Month</span>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center gap-3 flex-wrap">
                                        ...
                                        <div class="flex-fill">
                                            ...
                                            <span class="d-block text-muted mb-1">Profit By Sale</span>
                                            <span class="d-block fs-12 text-success fw-medium"><i class="ti ti-arrow-narrow-up"></i>0.18% This Month</span>
                                        </div>
                                        <div id="profit-per-sale"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-start justify-content-between gap-5 mt-3">
                                        <div class="flex-fill">
                                            <span class="d-block mb-1 text-default">Income</span>
                                            <div class="progress mb-3 rounded-0 p-1 border border-primary border-opacity-10" role="progressbar" aria-label="Basic example" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100">
                                                <div class="progress-bar" style="width: 65%"></div>
                                            </div>
                                        </div>
                                        <div class="text-end">
                                            <span class="d-block text-fixed-white">$47,289</span>
                                            <span class="d-block text-success fs-12 fw-semibold"><i class="ti ti-trending-up me-1 align-middle"></i>21%</span>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-start justify-content-between gap-5">
                                        <div class="flex-fill">
                                            <span class="d-block mb-1 text-default">Expenses</span>
                                            <div class="progress mb-3 rounded-0 p-1 border border-primary border-opacity-10" role="progressbar" aria-label="Basic example" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">
                                                <div class="progress-bar bg-secondary" style="width: 40%"></div>
                                            </div>
                                        </div>
                                        <div class="text-end">
                                            <span class="d-block text-fixed-white">$25,783</span>
                                            <span class="d-block text-danger fs-12 fw-semibold"><i class="ti ti-trending-up me-1 align-middle"></i>12%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="table text-nowrap table-striped table-borderless">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-sm btn-outline-light btn-wave">
                                                            <i class="fe fe-eye text-muted align-middle me-1 d-inline-block"></i>
                                                            View
                                                        </button>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="border-bottom-0"><span class="badge bg-primary-transparent">Completed</span></td>
                                                    <td class="border-bottom-0">
                                                        <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span class="avatar avatar-sm">
                                                                    <img src="{{asset('build/assets/images/ecommerce/jpg/18.jpg')}}" alt="">
                                                                </span>
                                                            </div>
...
@section('scripts')
        ...
        <!-- Tilt JS -->
        <script src="{{asset('build/assets/libs/vanilla-tilt/vanilla-tilt.min.js')}}"></script>
