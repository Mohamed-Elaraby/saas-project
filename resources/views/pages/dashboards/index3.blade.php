                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-start justify-content-between">
                                                <div>
                                                    <span class="d-block text-muted mb-3">Real Time Users</span>
                                                    <h3 class="fw-semibold">16.87K</h3>
                                                    <span class="d-block">Increased By <span class="text-success">0.2%</span> this month</span>
                                                </div>
                                                <div>
                                ...
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-start justify-content-between">
                                                <div>
                                                    <span class="d-block text-muted mb-3">Bounce rate</span>
                                                    <h3 class="fw-semibold">84.32%</h3>
                                                    <span class="d-block">Increased By <span class="text-success">4.15%</span> this month</span>
                                                </div>
                                                <div>
                                                    <span class="avatar bg-primary-transparent svg-primary">
                                                        <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><g><rect fill="none" height="24" width="24"/></g><g><g><g><path d="M7.5,4C5.57,4,4,5.57,4,7.5S5.57,11,7.5,11S11,9.43,11,7.5S9.43,4,7.5,4z M7.5,9C6.67,9,6,8.33,6,7.5S6.67,6,7.5,6 S9,6.67,9,7.5S8.33,9,7.5,9z M16.5,13c-1.93,0-3.5,1.57-3.5,3.5s1.57,3.5,3.5,3.5s3.5-1.57,3.5-3.5S18.43,13,16.5,13z M16.5,18 c-0.83,0-1.5-0.67-1.5-1.5s0.67-1.5,1.5-1.5s1.5,0.67,1.5,1.5S17.33,18,16.5,18z M5.41,20L4,18.59L18.59,4L20,5.41L5.41,20z"/></g></g></g></svg>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-start justify-content-between">
                                                <div>
                                                    <span class="d-block text-muted mb-3">Total Visitors</span>
                                                    <h3 class="fw-semibold">18,382</h3>
                                                    <span class="d-block">Decreased By <span class="text-danger">0.45%</span> this month</span>
                                                </div>
                                                <div>
                                                    <span class="avatar bg-primary-transparent svg-primary">
                                ...
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-start justify-content-between">
                                                <div>
                                                    <span class="d-block text-muted mb-3">Avg Visit Duration</span>
                                                    <h3 class="fw-semibold">2m 30s</h3>
                                                    <span class="d-block">Increased By <span class="text-success">12.42%</span> this month</span>
                                                </div>
                                                <div>
                                                    <span class="avatar bg-primary-transparent svg-primary">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="card custom-card">
                                        ...
                                        <div class="bottom-right"></div>
                                        <div class="card-header">
                                            <div class="card-title">VIEWS BY BROWSER</div>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-1">
                                                                <span class="avatar avatar-sm avatar-rounuded text-primary"><i class="ri-chrome-fill fs-18"></i></span>
                                                            </div>
                                                            <p class="mb-0">Chrome</p>
                                                        </div>
                                                    </td>
                                                    <td>23,379<i class="bi bi-caret-up-fill ms-2 fs-11 text-success"></i></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-1">
                                                                <span class="avatar avatar-sm avatar-rounuded text-secondary"><i class="ri-safari-fill fs-18"></i></span>
                                                            </div>
                                                            <p class="mb-0">Safari</p>
                                                        </div>
                                                    </td>
                                                    <td>20,937<i class="bi bi-caret-up-fill ms-2 fs-11 text-success"></i></td>
                                                    <td>
                                                        <div class="progress progress-xs"> 
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-1">
                                                                <span class="avatar avatar-sm avatar-rounuded text-warning"><i class="ri-opera-fill fs-18"></i></span>
                                                            </div>
                                                            <p class="mb-0">Opera</p>
                                                        </div>
                                                    </td>
                                                    <td>20,848<i class="bi bi-caret-down-fill ms-2 fs-11 text-danger"></i></td>
                                                    <td>
                                                        <div class="progress progress-xs"> 
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-1">
                                                                <span class="avatar avatar-sm avatar-rounuded text-info"><i class="ri-firefox-fill fs-18"></i></span>
                                                            </div>
                                                            <p class="mb-0">Firefox</p>
                                                        </div>
                                                    </td>
                                                    <td>18,120<i class="bi bi-caret-up-fill ms-2 fs-11 text-success"></i></td>
                                                    <td>
                                                        <div class="progress progress-xs"> 
                                                ...
                                                <tr>
                                                    <td class="border-bottom-0">
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-1">
                                                                <span class="avatar avatar-sm avatar-rounuded text-danger"><i class="ri-edge-fill fs-18"></i></span>
                                                            </div>
                                                            <p class="mb-0">Edge</p>
                                                        </div>
                                                    </td>
                                                    <td class="border-bottom-0">11,120<i class="bi bi-caret-down-fill ms-2 fs-11 text-danger"></i></td>
                                                    <td class="border-bottom-0">
                                                        <div class="progress progress-xs"> 
                                        ...
                                        <table class="table text-nowrap table-striped table-borderless">
                                            ...
                                            <tbody>
                                                <tr>
                                                        ...
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-sm avatar-rounded bg-primary-transparent">
                                                                    <i class="ri-search-2-line fs-15"></i>
                                                                </span>
                                                            </div>
                                                    ...
                                                    <td>
                                                        <span>0 hrs : 0 mins : 32 secs</span>
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-light text-default">578</span>
                                                    </td>
                                                    <td>
                                                        <span>1.5</span>
                                                    </td>
                                                    <td>
                                                        <div class="hstack gap-2 fs-1">
                                                            ...
                                                            <a aria-label="anchor" href="javascript:void(0);" class="btn btn-icon btn-sm btn-success-light btn-wave"><i class="ri-edit-line"></i></a>
                                                            <a aria-label="anchor" href="javascript:void(0);" class="btn btn-icon btn-sm btn-danger-light btn-wave"><i class="ri-delete-bin-line"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span>0 hrs : 2 mins : 45 secs</span>
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-light text-default">278</span>
                                                    </td>
                                                    <td>
                                                        <span>3.2</span>
                                                    </td>
                                                ...
                                                <tr>
                                                        ...
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-sm avatar-rounded bg-danger-transparent">
                                                                    <i class="ri-share-forward-line fs-15"></i>
                                                                </span>
                                                            </div>
                                                            <div>Referral</div>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <span>0 hrs : 38 mins : 28 secs</span>
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-light text-default">782</span>
                                                    </td>
                                                    <td>
                                                        <span>1.4</span>
                                                    </td>
                                                ...
                                                <tr>
                                                        ...
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-sm avatar-rounded bg-success-transparent">
                                                                    <i class="ri-reactjs-line fs-15"></i>
                                                                </span>
                                                            </div>
                                                            <div>Social</div>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <span>0 hrs : 12 mins : 29 secs</span>
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-light text-default">622</span>
                                                    </td>
                                                    <td>
                                                        <span>1.6</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span>0 hrs : 14 mins : 27 secs</span>
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-light text-default">142</span>
                                                    </td>
                                                    <td>
                                                        <span>2.5</span>
                                                    </td>
                                                ...
                                                <tr>
                                                        ...
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-sm avatar-rounded bg-info-transparent">
                                                                    <i class="ri-bank-card-line fs-15"></i>
                                                                </span>
                                                            </div>
                                                            <div>Paid Search</div>
                                                        </div>
                                                    ...
                                                    <td class="border-bottom-0">
                                                        <span>0 hrs : 16 mins : 28 secs</span>
                                                    </td>
                                                    <td class="border-bottom-0">
                                                        <span class="badge bg-light text-default">178</span>
                                                    </td>
                                                    <td class="border-bottom-0">
                                                        <span>2.9</span>
                                                    </td>
