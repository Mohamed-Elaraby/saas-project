                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div id="basicwizard">
                                        <ul class="nav nav-tabs nav-justified mb-4 tab-style-6 p-0 d-block d-sm-flex">
                                            <li class="nav-item" data-target-form="#contactDetailForm">
                                                <a class="nav-link icon-btn d-flex align-items-center justify-content-center gap-1 text-nowrap active" data-bs-toggle="tab" data-toggle="tab" href="#contactDetail"><span class="d-sm-inline">Contact Detail</span></a>
                                            </li>
                                            <li class="nav-item" data-target-form="#jobDetailForm">
                                                <a class="nav-link icon-btn d-flex align-items-center justify-content-center gap-1 text-nowrap" data-bs-toggle="tab" data-toggle="tab" href="#jobDetail"><span class="d-sm-inline">Job Detail</span></a>
                                            </li>
                                            <li class="nav-item" data-target-form="#educationDetailForm">
                                                <a class="nav-link icon-btn d-flex align-items-center justify-content-center gap-1 text-nowrap" data-bs-toggle="tab" data-toggle="tab" href="#educationDetail"><span class="d-sm-inline">Education Detail</span></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link icon-btn d-flex align-items-center justify-content-center gap-1 text-nowrap" data-bs-toggle="tab" data-toggle="tab" href="#finish"><span class="d-sm-inline">Finish</span></a>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="contactDetail">
                                                <form id="contactForm01" class="needs-validation" novalidate>
                                                    <div class="mb-3">
                                            ...
                                            <div class="tab-pane" id="jobDetail">
                                                <form id="jobForm" class="needs-validation" novalidate>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="company02" class="form-label">Company:</label>
                                                        <input type="text" id="company02" name="company02" class="form-control" required>
                                                    </div>
                                                
                                                    <div class="mb-3">
                                                        <label for="location02" class="form-label">Location:</label>
                                                        <input type="text" id="location02" name="location02" class="form-control" required>
                                                    </div>
                                            ...
                                            <div class="d-flex wizard justify-content-between mt-3 flex-wrap gap-1">
                                                <div class="first">
                                                ...
                                                <div class="d-md-flex">
                                                    ...
                                                    <div class="next">
                                                        <a href="javascript:void(0);" class="btn icon-btn btn-secondary mt-3 mt-md-0">
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div id="progresswizard">
                                        <ul class="nav nav-justified mb-4 tab-style-8 scaleX p-0 d-block d-sm-flex">
                                            <li class="nav-item" data-target-form="#progress-contactDetailForm">
                                                <a class="nav-link icon-btn d-flex align-items-center justify-content-center gap-1 text-nowrap active" data-bs-toggle="tab" data-toggle="tab" href="#progress-contactDetail"><span class="d-sm-inline">Contact Detail</span></a>
                                            </li>
                                            <li class="nav-item" data-target-form="#progress-jobDetailForm">
                                                <a class="nav-link icon-btn d-flex align-items-center justify-content-center gap-1 text-nowrap" data-bs-toggle="tab" data-toggle="tab" href="#progress-jobDetail"><span class="d-sm-inline">Job Detail</span></a>
                                            </li>
                                            <li class="nav-item" data-target-form="#progress-educationDetailForm">
                                                <a class="nav-link icon-btn d-flex align-items-center justify-content-center gap-1 text-nowrap" data-bs-toggle="tab" data-toggle="tab" href="#progress-educationDetail"><span class="d-sm-inline">Education Detail</span></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link icon-btn d-flex align-items-center justify-content-center gap-1 text-nowrap" data-bs-toggle="tab" data-toggle="tab" href="#progress-finish"><span class="d-sm-inline">Finish</span></a>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane show active" id="progress-contactDetail">
                                                <form id="contactForm" class="needs-validation" novalidate>
                                                    <div class="mb-3">
                                                        <label for="fullName01" class="form-label">Full Name:</label>
                                                        <input type="text" id="fullName01" name="fullName01" class="form-control" required>
                                                    </div>
                                                
                                                    <div class="mb-3">
                                                        <label for="email01" class="form-label">Email:</label>
                                                        <input type="email" id="email01" name="email01" class="form-control" required>
                                                    </div>
                                                
                                                    <div class="mb-3">
                                                        <label for="phoneNumber01" class="form-label">Phone Number:</label>
                                                        <input type="tel" id="phoneNumber01" name="phoneNumber01" class="form-control" pattern="[0-9]{10}" placeholder="Enter 10-digit phone number">
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="tab-pane" id="progress-jobDetail">
                                                <form id="jobForm01" class="needs-validation" novalidate>
                                                    <div class="mb-3">
                                                        <label for="jobTitle01" class="form-label">Job Title:</label>
                                                        <input type="text" id="jobTitle01" name="jobTitle01" class="form-control" required>
                                                    </div>
                                                
                                                    <div class="mb-3">
                                                        <label for="company01" class="form-label">Company:</label>
                                                        <input type="text" id="company01" name="company01" class="form-control" required>
                                                    </div>
                                                
                                                    <div class="mb-3">
                                                        <label for="location01" class="form-label">Location:</label>
                                                        <input type="text" id="location01" name="location01" class="form-control" required>
                                                    </div>
                                                
                                                    <div class="mb-3">
                                                        <label for="jobDescription01" class="form-label">Job Description:</label>
                                                        <textarea id="jobDescription01" name="jobDescription01" class="form-control" rows="4" required></textarea>
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="tab-pane" id="progress-educationDetail">
                                                <form id="educationForm01" class="needs-validation" novalidate>
                                                    <div class="mb-3">
                                                        <label for="degree01" class="form-label">Degree:</label>
                                                        <input type="text" id="degree01" name="degree01" class="form-control" required>
                                                    </div>
                                                
                                                    <div class="mb-3">
                                                        <label for="institution01" class="form-label">Institution:</label>
                                                        <input type="text" id="institution01" name="institution01" class="form-control" required>
                                                    </div>
                                                
                                                    <div class="mb-3">
                                                        <label for="graduationYear01" class="form-label">Graduation Year:</label>
                                                        <input type="number" id="graduationYear01" name="graduationYear01" class="form-control" min="1900" max="2100" required>
                                                    </div>
                                                
                                                    <div class="mb-3">
                                                        <label for="fieldOfStudy01" class="form-label">Field of Study:</label>
                                                        <input type="text" id="fieldOfStudy01" name="fieldOfStudy01" class="form-control" required>
                                                    </div>
                                                </form>
                                            </div>
                                        ...
                                        <aside class="wizard-content container">
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="register-page">
                                                            ...
                                                            <div class="row gy-3">
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <label for="Ph-Number" class="form-label">Phone Number</label>
                                                                    <div class="input-group">
                                                                        <span class="input-group-text"
                                                                            id="inputGroup-sizing-default">+99</span>
                                                                        <input type="text" class="form-control " id="Ph-Number"
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <label for="select-city" class="form-label">Select City
                                                                        :</label>
                                                                    <select class="form-control" data-trigger
                                                                        name="select-city"
                                                                        id="select-city">
                                            ...
                                            <div class=" wizard-step active" data-title="Select Service"
                                                ...
                                                <div class="row gy-4">
                                                    <div class="col-xl-3">
                                                        <div class="col">
                                                            <div class="form-check d-flex align-items-center gap-3 p-2 border">
                                                                <div>
                                                    ...
                                                    <div class="col-xl-3">
                                                        <div class="col">
                                                            <div class="form-check d-flex align-items-center gap-3 p-2 border">
                                                                <div>
                                                                    <span class="avatar avatar-lg bg-orange-transparent">
                                                                        <i class="bi bi-hospital fs-5"></i>
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                                    ...
                                                                    <div class="card custom-card border shadow-none mb-3">
                                                                        ...
                                                                        <div class="card-footer">
                                                                            <div class="row gy-3">
                                                                                ...
                                                                                <div class="col-xl-6">
                                                                                    <div class="form-check payment-card-container mb-0 lh-1 saved-cards">
                                                                                        <input id="payment-card1" name="payment-cards" type="radio" class="form-check-input" checked>
                                                                                        <div class="form-check-label pe-5">
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12">
                                                        <div class="checkout-payment-success">
                                                            ...
                                                            <div class="mb-4">
                                                                <p class="mb-1 fs-14">You will get the appointment details with appointment id <b>SPK#1FR</b> to <a class="link-success" href="javascript:void(0);"><u>Martin12@gamil.com</u></a></p>
