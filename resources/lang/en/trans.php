...
return [
    ...
    'enable'                                                                        => ucwords('enable'),
    'disable'                                                                       => ucwords('disable'),
    'yes'                                                                           => ucwords('yes'),
    'no'                                                                            => ucwords('no'),
    'from'                                                                          => ucwords('from'),
    'to'                                                                            => ucwords('to'),
    'statement period'                                                              => ucwords('statement period'),
    'statement'                                                                     => ucwords('statement'),
    'download'                                                                      => ucwords('download'),
    'pdf'                                                                           => ucwords('pdf'),
    'advances and salaries'                                                         => ucwords('advances and salaries'),
    'card details'                                                                  => ucwords('card details'),
    'incoming'                                                                      => ucwords('incoming'),
    'total incoming'                                                                => ucwords('total incoming'),
    'bank and transfer and network'                                                 => ucwords('bank and transfer and network'),
    'previous balance'                                                              => ucwords('previous balance'),
    'current balance'                                                               => ucwords('current balance'),
    'logo'                                                                          => ucwords('logo'),
    ...
    'pleas upload your company logo'                                                => ucwords('pleas upload your company logo'),
    'company logo notice'                                                           => ucwords('image size should be preferable 100px X 100px'),
    'upload photo'                                                                  => ucwords('upload photo'),
    'remove photo'                                                                  => ucwords('remove photo'),
    'search'                                                                        => ucwords('search'),
    'reload'                                                                        => ucwords('reload'),
    'print'                                                                         => ucwords('print'),
    'transport'                                                                     => ucwords('transport'),
    'transfer'                                                                      => ucwords('transfer'),
    'advanced search'                                                               => ucwords('advanced search'),
    'general setting'                                                               => ucwords('general setting'),
    'setting'                                                                       => ucwords('setting'),
    'title'                                                                         => ucwords('title'),
    'description'                                                                   => ucwords('description'),
    'keywords'                                                                      => ucwords('keywords'),
    'update your site settings'                                                     => ucwords('Update your site settings'),
    'date'                                                                          => ucwords('date'),
    'debit'                                                                         => ucwords('debit'),
    ...
    'total including vat'                                                           => ucwords('total including vat'),
    'total'                                                                         => ucwords('total'),
    ...
    'rounding'                                                                      => ucwords('rounding'),
    'cancel rounding'                                                               => ucwords('cancel rounding'),
    'choose branch'                                                                 => ucwords('choose branch'),
    'choose date'                                                                   => ucwords('choose date'),
    'save as draft'                                                                 => ucwords('save as draft'),
    'issuing the final invoice'                                                     => ucwords('issuing the final invoice'),
    'vat'                                                                           => ucwords('vat'),
    'tax percentage'                                                                => ucwords('tax percentage'),
    ...
    'withdrawal'                                                                    => ucwords('withdrawal'),
    'process type'                                                                  => ucwords('process type'),
    'send'                                                                          => ucwords('send'),
    'cash'                                                                          => ucwords('cash'),
    'bank transfer'                                                                 => ucwords('bank transfer'),
    'network'                                                                       => ucwords('network'),
    'other'                                                                         => ucwords('other'),
    'amount paid in cash'                                                           => ucwords('amount paid in cash'),
    'amount paid into the bank'                                                     => ucwords('amount paid into the bank'),
    'financial custody from the administration'                                     => ucwords('financial custody from the administration'),
    'cash to administration'                                                        => ucwords('cash to administration'),
    'safe money process type place holder'                                          => ucwords('choose the process type on the safe money withDrawl or deposit'),
    'collecting document'                                                           => ucwords('collecting document'),
    'collecting document from customer'                                             => ucwords('collecting document from customer'),
    'collecting document from client'                                               => ucwords('collecting document from client'),
    'payment document'                                                              => ucwords('payment document'),
    'payment document to customer'                                                  => ucwords('payment document to customer'),
    'collecting document from supplier'                                             => ucwords('collecting document from supplier'),
    'payment document to supplier'                                                  => ucwords('payment document to supplier'),
    'edit'                                                                          => ucwords('edit'),
    'amount paid'                                                                   => ucwords('amount paid'),
    'Amount collected'                                                              => ucwords('Amount collected'),
    'via'                                                                           => ucwords('via'),
    'to supplier'                                                                   => ucwords('to supplier'),
    'from supplier'                                                                 => ucwords('from supplier'),
    'to client'                                                                     => ucwords('to client'),
    'from client'                                                                   => ucwords('from client'),
    'in branch'                                                                     => ucwords('in branch'),
    'this is for'                                                                   => ucwords('this is for'),
    'part'                                                                          => ucwords('part'),
    'and part'                                                                      => ucwords('and part'),
    'document details'                                                              => ucwords('document details'),
    'document number'                                                               => ucwords('document number'),
    'supplier signature'                                                            => ucwords('supplier signature'),
    'receiver signature'                                                            => ucwords('receiver signature'),
    'company stamp'                                                                 => ucwords('company stamp'),
    'collection receipt'                                                            => ucwords('collection receipt'),
    'receipt of payment'                                                            => ucwords('receipt of payment'),
    ...
    'home'                                                                          => ucwords('home'),
    'color'                                                                         => ucwords('color'),
    'elements'                                                                      => ucwords('elements'),
    'enter element name'                                                            => ucwords('enter element name'),
    'element name'                                                                  => ucwords(' element name'),
    'create element'                                                                => ucwords('create element'),
    'enter role name'                                                               => ucwords('enter role name'),
    'enter role display name'                                                       => ucwords('enter role display name'),
    'role display name'                                                             => ucwords('role display name'),
    'enter role description'                                                        => ucwords('enter role description'),
    'image'                                                                         => ucwords('image'),
    'file'                                                                          => ucwords('file'),
    'hand labour'                                                                   => ucwords('hand labour'),
    'new parts'                                                                     => ucwords('new parts'),
    'used parts'                                                                    => ucwords('used parts'),
    'file type'                                                                     => ucwords('file type'),
    'manage roles and permissions and teams'                                        => ucwords('manage roles and permissions and teams'),
    ...
    'user created successfully'                                                     => ucwords('user created successfully'),
    'user updated successfully'                                                     => ucwords('user updated successfully'),
    'user deleted successfully'                                                     => ucwords('user deleted successfully'),
    'role'                                                                          => ucwords('role'),
    'roles'                                                                         => ucwords('roles'),
    ...
    'languages'                                                                     => ucwords('languages'),
    'language'                                                                      => ucwords('language'),
    'currencies'                                                                    => ucwords('currencies'),
    ...
    'image deleted successfully'                                                    => ucwords('image deleted successfully'),
    'edit or close invoice'                                                         => ucwords('edit or close invoice'),
    'create return invoice'                                                         => ucwords('create return invoice'),
    'clients management'                                                            => ucwords('clients management'),
    'suppliers management'                                                          => ucwords('suppliers management'),
    'expenses management'                                                           => ucwords('expenses management'),
    'categories management'                                                         => ucwords('categories management'),
    'products management'                                                           => ucwords('products management'),
    'bills management'                                                              => ucwords('bills management'),
    'pending bills management'                                                      => ucwords('pending bills management'),
    'return bills management'                                                       => ucwords('return bills management'),
    'at least one product must be added to the invoice'                             => ucwords('at least one product must be added to the invoice'),
    ...
    'client created successfully'                                                   => ucwords('client created successfully'),
    'client updated successfully'                                                   => ucwords('client updated successfully'),
    'client deleted successfully'                                                   => ucwords('client deleted successfully'),
    'client data'                                                                   => ucwords('client data'),
    'driver name'                                                                   => ucwords('driver name'),
    'client balance'                                                                => ucwords('client balance'),
    ...
    'client payment created successfully'                                         => ucwords('client payment created successfully'),
    ...
    'client collecting created successfully'                                       => ucwords('client collecting created successfully'),
    ...
    'supplier created successfully'                                                 => ucwords('supplier created successfully'),
    'supplier updated successfully'                                                 => ucwords('supplier updated successfully'),
    'supplier deleted successfully'                                                 => ucwords('supplier deleted successfully'),
    'supplier data'                                                                 => ucwords('supplier data'),
    'supplier balance'                                                              => ucwords('supplier balance'),
    ...
    'supplier payment created successfully'                                         => ucwords('supplier payment created successfully'),
    'supplier payment updated successfully'                                         => ucwords('supplier payment updated successfully'),
    'supplier payment deleted successfully'                                         => ucwords('supplier payment deleted successfully'),
    ...
    'supplier collecting created successfully'                                       => ucwords('supplier collecting created successfully'),
    ...
    'category created successfully'                                                 => ucwords('category created successfully'),
    'category updated successfully'                                                 => ucwords('category updated successfully'),
    'category deleted successfully'                                                 => ucwords('category deleted successfully'),
    'choose category'                                                               => ucwords('choose category'),
    ...
    'sub categories'                                                                => ucwords('sub categories'),
    ...
    'sub category created successfully'                                             => ucwords('sub category created successfully'),
    'sub category updated successfully'                                             => ucwords('sub category updated successfully'),
    'sub category deleted successfully'                                             => ucwords('sub category deleted successfully'),
    'sub category of'                                                               => ucwords('sub category of'),
    'choose main category'                                                          => ucwords('choose main category'),
    'delete main category message'                                                  => ucwords('Deleting this category will delete all sub category associated with it and their data! Do you want to delete the category ?'),
    'delete sub category message'                                                   => ucwords('Deleting this section will delete all data associated with it! Do you want to delete the section ?'),


    // Expenses Translations
    'all expenses list'                                                             => ucwords('all expenses list'),
    'expenses name'                                                                 => ucwords('expenses name'),
    'expenses date'                                                                 => ucwords('expenses date'),
    ...
    'expenses created successfully'                                                 => ucwords('expenses created successfully'),
    'expenses updated successfully'                                                 => ucwords('expenses updated successfully'),
    'expenses deleted successfully'                                                 => ucwords('expenses deleted successfully'),
    ...
    'expenses type created successfully'                                            => ucwords('expenses type created successfully'),
    'expenses type updated successfully'                                            => ucwords('expenses type updated successfully'),
    'expenses type deleted successfully'                                            => ucwords('expenses type deleted successfully'),

    // Purchase Orders Translations
    'all purchase orders list'                                                      => ucwords('all purchase orders list'),
    'purchase orders'                                                               => ucwords('purchase orders'),
    ...
    'create purchase order from supplier'                                           => ucwords('create purchase order from supplier'),
    ...
    'create closed sale order'                                                      => ucwords('create closed sale order'),
    ...
    'product created successfully'                                                  => ucwords('product created successfully'),
    'product updated successfully'                                                  => ucwords('product updated successfully'),
    'product deleted successfully'                                                  => ucwords('product deleted successfully'),

    // Bank Code Translations
    'bank'                                                                          => ucwords('bank'),
    'operation on the bank'                                                         => ucwords('operation on the bank'),
    'the amount in the bank is not enough'                                          => ucwords('the amount in the bank is not enough'),
    ...
    'product code created successfully'                                            => ucwords('product code created successfully'),
    'product code updated successfully'                                            => ucwords('product code updated successfully'),
    'product code deleted successfully'                                            => ucwords('product code deleted successfully'),
    ...
    'branches'                                                                      => ucwords('branches'),
    'branch created successfully'                                                   => ucwords('branch created successfully'),
    'branch updated successfully'                                                   => ucwords('branch updated successfully'),
    'branch deleted successfully'                                                   => ucwords('branch deleted successfully'),
    'branch required'                                                               => ucwords('the branch field is required.'),
    ...
    'other car'                                                                     => ucwords('do you have another car ?'),
