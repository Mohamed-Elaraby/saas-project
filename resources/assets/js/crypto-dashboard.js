...
(function () {
    ...
    const values = [{
    value: '1',
    label: '<img class="avatar avatar-xs avatar-rounded me-1" src="http://127.0.0.1:8000/build/assets/images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg" /> Bitcoin',
    id: 1
  }, {
    value: '2', 
    label: '<img class="avatar avatar-xs avatar-rounded me-1" src="http://127.0.0.1:8000/build/assets/images/crypto-currencies/crypto-icons/cardano-ada-logo.svg" /> Cardano',
    id: 2
  }, {
    value: '3',
    label: '<img class="avatar avatar-xs avatar-rounded me-1" src="http://127.0.0.1:8000/build/assets/images/crypto-currencies/crypto-icons/dogecoin-doge-logo.svg" /> DodgeCoin',
    id: 3
  }, {
    value: '4',
    label: '<img class="avatar avatar-xs avatar-rounded me-1" src="http://127.0.0.1:8000/build/assets/images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg" /> Ethereum',
    id: 4
  }, {
    value: '5',
    label: '<img class="avatar avatar-xs avatar-rounded me-1" src="http://127.0.0.1:8000/build/assets/images/crypto-currencies/crypto-icons/tether-usdt-logo.svg" /> Tether',
    id: 5
  }]
